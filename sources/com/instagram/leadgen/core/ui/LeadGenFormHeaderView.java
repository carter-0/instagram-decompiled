...
public final class LeadGenFormHeaderView extends ConstraintLayout {
    ...
    public LeadGenFormHeaderView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.A05 = DbT.A0b(this, R.id.lead_form_header_image);
        this.A01 = DbT.A0a(this, R.id.num_questions_text_view);
        this.A03 = DbT.A0a(this, R.id.welcome_message_text_view);
        this.A04 = DbU.A0X(this, R.id.lead_form_profile_image);
        this.A02 = DbT.A0a(this, R.id.username_text_view);
