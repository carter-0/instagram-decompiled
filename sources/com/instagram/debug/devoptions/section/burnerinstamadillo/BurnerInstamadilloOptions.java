...
public final class BurnerInstamadilloOptions implements DeveloperOptionsSection {
    ...
    public List getItems(UserSession userSession, FragmentActivity fragmentActivity, AnonymousClass4DH r6, AnonymousClass07i r7) {
        ...
        return AnonymousClass7TE.A1I(new C50989Fmc((Context) fragmentActivity, (View.OnClickListener) new BurnerInstamadilloOptions$getItems$1(fragmentActivity, userSession), (CharSequence) "Bulk Send"));
    }
