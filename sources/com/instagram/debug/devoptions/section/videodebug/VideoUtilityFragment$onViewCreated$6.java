...
public final class VideoUtilityFragment$onViewCreated$6 implements View.OnClickListener {
    public final /* synthetic */ VideoUtilityFragment this$0;

    public VideoUtilityFragment$onViewCreated$6(VideoUtilityFragment videoUtilityFragment) {
        this.this$0 = videoUtilityFragment;
    }

    public final void onClick(View view) {
        String str;
        int A05 = AnonymousClass0fD.A05(1592368532);
        ...
        if (r2 == null) {
            ...
            if (seekBar == null) {
                ...
                r2.EKy(Math.max(seekBar.getProgress() - 30000, 0), true);
                AnonymousClass0fD.A0C(-1345530063, A05);
                return;
            }
        }
        0qQ.A0F(str);
