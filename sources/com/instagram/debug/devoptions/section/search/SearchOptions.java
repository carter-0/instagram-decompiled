...
public final class SearchOptions implements DeveloperOptionsSection {
    ...
    public List getItems(UserSession userSession, FragmentActivity fragmentActivity, AnonymousClass4DH r6, AnonymousClass07i r7) {
        ...
        return AnonymousClass7TE.A1I(new C50989Fmc((Context) fragmentActivity, (View.OnClickListener) new SearchOptions$getItems$1(fragmentActivity, userSession), (CharSequence) fragmentActivity.getString(2131958277)));
    }
