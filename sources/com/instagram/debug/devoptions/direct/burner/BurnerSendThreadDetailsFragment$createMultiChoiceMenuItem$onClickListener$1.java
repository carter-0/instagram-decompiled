...
public final class BurnerSendThreadDetailsFragment$createMultiChoiceMenuItem$onClickListener$1 implements View.OnClickListener {
    ...
    public BurnerSendThreadDetailsFragment$createMultiChoiceMenuItem$onClickListener$1(BurnerSendThreadDetailsFragment burnerSendThreadDetailsFragment, String[] strArr, 0sP r3, Object[] objArr, C50989Fmc fmc, CharSequence charSequence, C68504NKx nKx) {
    ...
    public final void onClick(View view) {
        int A05 = AnonymousClass0fD.A05(-1365974663);
        ...
        for (final int i = 0; i < length; i++) {
            ...
            dg1.A0C(str, new View.OnClickListener() {
                public final void onClick(View view) {
                    int A05 = AnonymousClass0fD.A05(-2014006437);
                    r5.invoke(objArr[i]);
                    C50989Fmc fmc = fmc;
                    ...
                    AnonymousClass0fD.A0C(1348208261, A05);
                }
            });
        }
        new C49945FFy(dg1).A05(this.this$0.requireContext());
        AnonymousClass0fD.A0C(50475114, A05);
    }
}
