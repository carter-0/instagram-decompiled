...
public final class SandboxPreferences$observeCurrentSandbox$$inlined$observeDevPreference$1 extends AnonymousClass1Ek implements 0sL {
    ...
    public SandboxPreferences$observeCurrentSandbox$$inlined$observeDevPreference$1(SandboxPreferences sandboxPreferences, AnonymousClass4D7 r3, SandboxPreferences sandboxPreferences2) {
        super(2, r3);
        this.this$0$inline_fun = sandboxPreferences;
        this.this$0 = sandboxPreferences2;
    }

    /* JADX WARNING: type inference failed for: r0v0, types: [com.instagram.debug.devoptions.sandboxselector.SandboxPreferences$observeCurrentSandbox$$inlined$observeDevPreference$1, X.4D7] */
    public final AnonymousClass4D7 create(Object obj, AnonymousClass4D7 r5) {
        ? sandboxPreferences$observeCurrentSandbox$$inlined$observeDevPreference$1 = new SandboxPreferences$observeCurrentSandbox$$inlined$observeDevPreference$1(this.this$0$inline_fun, r5, this.this$0);
    ...
    public final Object invoke(C252683pV r3, AnonymousClass4D7 r4) {
        return ((SandboxPreferences$observeCurrentSandbox$$inlined$observeDevPreference$1) create(r3, r4)).invokeSuspend(C60340gF.A00);
    }

    /* JADX WARNING: type inference failed for: r6v0, types: [com.instagram.debug.devoptions.sandboxselector.SandboxPreferences$observeCurrentSandbox$$inlined$observeDevPreference$1, X.4D7] */
        ...
        if (i == 0) {
            ...
            0ki.A00("SandboxPreferences.kt-observeDevPreference-1", new C62320sa() {
                public final void invoke() {
                    r3.FIG(sandboxPreferences.getCurrentSandbox());
                }
            });
                ...
                public final void onChanged(0xa r4, String str) {
                    if (0qQ.A0K(str, "using_dev_server") || 0qQ.A0K(str, "dev_server_name")) {
                        ...
                        0ki.A00("SandboxPreferences.kt-observeDevPReference-2", new C62320sa() {
                            public final void invoke() {
                                r2.FIG(sandboxPreferences.getCurrentSandbox());
                            }
                        });
                    }
                }
