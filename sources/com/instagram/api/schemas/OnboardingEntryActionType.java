...
public enum OnboardingEntryActionType implements Parcelable {
    ...
    static {
        int i;
        OnboardingEntryActionType[] onboardingEntryActionTypeArr;
        A02 = 0oU.A00(onboardingEntryActionTypeArr);
        int A0L = 0se.A0L(r3);
        if (A0L < 16) {
            A0L = 16;
        }
        ...
        for (OnboardingEntryActionType onboardingEntryActionType : values()) {
            linkedHashMap.put(onboardingEntryActionType.A00, onboardingEntryActionType);
        }
        A01 = linkedHashMap;
        CREATOR = new C376389Hu(88);
    }
