...
public enum BirthdayVisibilityForViewer implements Parcelable {
    ...
    static {
        int i;
        BirthdayVisibilityForViewer[] birthdayVisibilityForViewerArr;
        A02 = 0oU.A00(birthdayVisibilityForViewerArr);
        int A0L = 0se.A0L(r3);
        if (A0L < 16) {
            A0L = 16;
        }
        ...
        for (BirthdayVisibilityForViewer birthdayVisibilityForViewer : values()) {
            linkedHashMap.put(birthdayVisibilityForViewer.A00, birthdayVisibilityForViewer);
        }
        A01 = linkedHashMap;
        CREATOR = new C376409Hw(59);
    }
