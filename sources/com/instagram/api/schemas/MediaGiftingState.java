...
public enum MediaGiftingState implements Parcelable {
    ...
    static {
        int i;
        MediaGiftingState[] mediaGiftingStateArr;
        A02 = 0oU.A00(mediaGiftingStateArr);
        int A0L = 0se.A0L(r3);
        if (A0L < 16) {
            A0L = 16;
        }
        ...
        for (MediaGiftingState mediaGiftingState : values()) {
            linkedHashMap.put(mediaGiftingState.A00, mediaGiftingState);
        }
        A01 = linkedHashMap;
        CREATOR = new C376389Hu(57);
    }
