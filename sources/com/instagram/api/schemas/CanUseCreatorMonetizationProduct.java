...
public enum CanUseCreatorMonetizationProduct implements Parcelable {
    ...
    static {
        int i;
        CanUseCreatorMonetizationProduct[] canUseCreatorMonetizationProductArr;
        A02 = 0oU.A00(canUseCreatorMonetizationProductArr);
        int A0L = 0se.A0L(r3);
        if (A0L < 16) {
            A0L = 16;
        }
        ...
        for (CanUseCreatorMonetizationProduct canUseCreatorMonetizationProduct : values()) {
            linkedHashMap.put(canUseCreatorMonetizationProduct.A00, canUseCreatorMonetizationProduct);
        }
        A01 = linkedHashMap;
        CREATOR = new C376409Hw(65);
    }
