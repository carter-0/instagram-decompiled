...
public enum FanClubNextStepsCompletionState implements Parcelable {
    ...
    static {
        int i;
        FanClubNextStepsCompletionState[] fanClubNextStepsCompletionStateArr;
        A02 = 0oU.A00(fanClubNextStepsCompletionStateArr);
        LinkedHashMap A0x = DbS.A0x(AnonymousClass7TG.A01(r3));
        for (FanClubNextStepsCompletionState fanClubNextStepsCompletionState : values()) {
            A0x.put(fanClubNextStepsCompletionState.A00, fanClubNextStepsCompletionState);
        }
        A01 = A0x;
        CREATOR = DE7.A00(68);
    }
