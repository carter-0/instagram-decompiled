...
public enum MiniShopSellerOnboardingStatus implements Parcelable {
    ...
    static {
        int i;
        MiniShopSellerOnboardingStatus[] miniShopSellerOnboardingStatusArr;
        A02 = 0oU.A00(miniShopSellerOnboardingStatusArr);
        LinkedHashMap A0x = DbS.A0x(AnonymousClass7TG.A01(r3));
        for (MiniShopSellerOnboardingStatus miniShopSellerOnboardingStatus : values()) {
            A0x.put(miniShopSellerOnboardingStatus.A00, miniShopSellerOnboardingStatus);
        }
        A01 = A0x;
        CREATOR = FK5.A00(82);
    }
