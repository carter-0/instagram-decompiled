...
public enum StoryPromptDisablementState implements Parcelable {
    ...
    static {
        int i;
        StoryPromptDisablementState[] storyPromptDisablementStateArr;
        A02 = 0oU.A00(storyPromptDisablementStateArr);
        int A0L = 0se.A0L(r3);
        if (A0L < 16) {
            A0L = 16;
        }
        ...
        for (StoryPromptDisablementState storyPromptDisablementState : values()) {
            linkedHashMap.put(storyPromptDisablementState.A00, storyPromptDisablementState);
        }
        A01 = linkedHashMap;
        CREATOR = new C376419Hx(31);
    }
