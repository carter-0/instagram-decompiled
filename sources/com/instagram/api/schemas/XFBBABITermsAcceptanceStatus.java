...
public enum XFBBABITermsAcceptanceStatus implements Parcelable {
    ...
    static {
        int i;
        XFBBABITermsAcceptanceStatus[] xFBBABITermsAcceptanceStatusArr;
        A02 = 0oU.A00(xFBBABITermsAcceptanceStatusArr);
        LinkedHashMap A0x = DbS.A0x(AnonymousClass7TG.A01(r3));
        for (XFBBABITermsAcceptanceStatus xFBBABITermsAcceptanceStatus : values()) {
            A0x.put(xFBBABITermsAcceptanceStatus.A00, xFBBABITermsAcceptanceStatus);
        }
        A01 = A0x;
        CREATOR = FK6.A00(67);
    }
