...
public class IGSecureMessageCryptoProvider {
    ...
    public static byte[] createCbcHmacEncryptedDataHandler(byte[] bArr, byte[] bArr2) {
        ...
        0wb.A03("msys_ig_create_cbc_hmac_encrypted_data", str);
        return null;
    }
    ...
    public static byte[] doHmacSHA256(byte[] bArr, byte[] bArr2) {
        ...
        if (bArr2 == null) {
            0wb.A03("msys_ig_do_hmac_sha_256", "Given data is null.");
            return null;
        }
        Mac mac = getMac();
        if (bArr != null) {
            try {
                ...
                0wb.A07("msys_ig_do_hmac_sha_256", e);
                return null;
            }
        }
    ...
    public static byte[] getCiphertext(SecretKeySpec secretKeySpec, IvParameterSpec ivParameterSpec, byte[] bArr) {
        try {
            ...
            0wb.A07("msys_ig_get_cipher_text", e);
            return null;
        }
    }
    ...
    public static byte[] getPlaintext(SecretKeySpec secretKeySpec, IvParameterSpec ivParameterSpec, byte[] bArr) {
        try {
            ...
            0wb.A07("msys_ig_get_plain_text", e);
            return null;
        }
    }
            ...
            if (doHmacSHA256 != null) {
                ...
                while (i2 < ceil) {
                    ...
                    try {
                        ...
                        0wb.A07("msys_ig_create_sha_256_hkdf_data", e);
                ...
                0wb.A03("msys_ig_create_sha_256_hkdf_data", "copiedBytes did not come back with the correct size.");
                throw new AssertionError("copiedBytes did not come back with the correct size.");
            }
            0wb.A03("msys_ig_create_sha_256_hkdf_data", "hmac came back null.");
            throw new AssertionError("doHmacSHA256 returns null.");
        }
        0wb.A03("msys_ig_create_sha_256_hkdf_data", "Output size is too big.");
    ...
    public static byte[] getSHA256Hash(byte[] bArr) {
        try {
            ...
            0wb.A07("msys_ig_get_sha_256_hash", e);
            throw new AssertionError(e);
        }
    }
