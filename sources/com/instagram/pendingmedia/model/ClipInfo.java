...
public final class ClipInfo extends AnonymousClass0T0 implements Parcelable, AnonymousClass3QI {
    public static final AnonymousClass0eM A0Q = AnonymousClass0eN.A01(AnonymousClass3QJ.A00);
    public static final C376399Hv CREATOR = new C376399Hv(66);
    public float A00;
    public float A01;
    public float A02;
    public int A03;
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof ClipInfo) {
                ...
                if (!(0qQ.A0K(this.A0F, clipInfo.A0F) && 0qQ.A0K(this.A0D, clipInfo.A0D) && this.A03 == clipInfo.A03 && Float.compare(this.A02, clipInfo.A02) == 0 && 0qQ.A0K(this.A0C, clipInfo.A0C) && this.A04 == clipInfo.A04 && Float.compare(this.A00, clipInfo.A00) == 0 && this.A07 == clipInfo.A07 && this.A05 == clipInfo.A05 && this.A0H == clipInfo.A0H && this.A08 == clipInfo.A08 && this.A09 == clipInfo.A09 && this.A06 == clipInfo.A06 && 0qQ.A0K(this.A0E, clipInfo.A0E) && this.A0L == clipInfo.A0L && this.A0J == clipInfo.A0J && this.A0K == clipInfo.A0K && this.A0N == clipInfo.A0N && this.A0A == clipInfo.A0A && this.A0M == clipInfo.A0M && 0qQ.A0K(this.A0B, clipInfo.A0B) && this.A0O == clipInfo.A0O && this.A0I == clipInfo.A0I && Float.compare(this.A01, clipInfo.A01) == 0)) {
                    return false;
                }
            }
            return false;
    ...
    public final String toString() {
        ...
        sb.append(", pan=");
        sb.append(this.A02);
        sb.append(AnonymousClass000.A00(404));
        sb.append(this.A0C);
        sb.append(C273654mx.A00(440));
        sb.append(this.A04);
    ...
    public /* synthetic */ ClipInfo(String str, int i) {
        ...
        if ((i & Constants.LOAD_RESULT_NEED_REOPTIMIZATION) != 0) {
            mediaUploadMetadata = new MediaUploadMetadata((ImmersiveMediaFields) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, false);
        } else {
            mediaUploadMetadata = null;
        }
        float f3 = (i & DalvikConstants.FB4A_LINEAR_ALLOC_BUFFER_SIZE) != 0 ? -1.0f : 0.0f;
        0qQ.A0B(mediaUploadMetadata, 21);
        this.A0F = str2;
        this.A0D = null;
        this.A03 = 0;
        this.A02 = f;
        ...
        this.A0I = false;
        this.A01 = f3;
        this.A0G = new 0eP((Object) null, 0L);
    }

    public final long A00() {
        if (!0qQ.A0K(this.A0G.A00, this.A0F)) {
            String str = this.A0F;
            this.A0G = new 0eP(str, Long.valueOf(0mb.A03(str)));
        }
