...
public final class MediaVideoScrubberBufferFrameLayout extends IgFrameLayout implements C258423yz {
    public boolean A00;
    ...
    public final void CMg(C62320sa r8, 0sP r9, int i, int i2) {
        0qQ.A0B(r9, 3);
        this.A01 = new C55992Hqy(r8, r9, new C59100J6i(this, 3), new C59100J6i(this, 4), i, i2);
        if (!isLaidOut() || isLayoutRequested()) {
            addOnLayoutChangeListener(new ID9(this, i2));
            return;
        }
