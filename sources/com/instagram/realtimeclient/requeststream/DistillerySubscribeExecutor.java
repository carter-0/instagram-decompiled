...
public class DistillerySubscribeExecutor extends SubscribeExecutor {
    public static DistillerySubscribeExecutor getInstance(UserSession userSession) {
        return (DistillerySubscribeExecutor) userSession.A01(DistillerySubscribeExecutor.class, new DistillerySubscribeExecutor$$ExternalSyntheticLambda0(userSession));
    }
    ...
    public JSONObject buildHeaderJson(GraphQLSubscriptionRequestStub graphQLSubscriptionRequestStub, String str) {
        ...
        try {
            ...
            jSONObject.put("method", 002.A0R("IGGQLS:", iGGraphQLSubscriptionRequestStringStub.getQueryName().toUpperCase(Locale.ENGLISH)));
            return jSONObject;
    ...
    public JSONObject buildPayload(GraphQLSubscriptionRequestStub graphQLSubscriptionRequestStub, String str) {
        ...
        try {
            ...
            jSONObject.put(AnonymousClass000.A00(1466), jSONObject2);
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [com.instagram.realtimeclient.requeststream.DistillerySubscribeExecutor, com.instagram.realtimeclient.requeststream.SubscribeExecutor] */
    ...
    public DistillerySubscribeExecutor(UserSession userSession, 1Ng r2) {
        super(userSession, r2);
    }

    public DistillerySubscribeExecutor(1xh r1, C58840Ae r2, 1Ng r3, C635813i r4, long j) {
        super(r1, r2, r3, r4, j);
    }
}
