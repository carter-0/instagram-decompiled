...
public final class RealtimeProtocol {
    ...
    public static final String DIRECT_FOLDER = "/direct_v2/inbox/folders";
    public static final String DIRECT_HIDE_CHANNELS_IN_MAIN_TAB_UPDATE = "/direct_v2/inbox/threads/:direct_v2_thread_id/hide_in_messages_primary_tab_setting";
    ...
    public static final String DIRECT_THREAD_DISAPPEARING_MODE_METADATA_UPDATE = "/direct_v2/threads/:direct_v2_thread_id/dm_settings";
    ...
    public static final String DIRECT_THREAD_INSTAMADILLO_CUTOVER_METADATA_UPDATE = "/direct_v2/threads/:direct_v2_thread_id/instamadillo_cutover_metadata";
    ...
    public static final String DIRECT_V2_BUMP_THREAD_TEMPLATE = "/direct_v2/threads/:direct_v2_thread_id/bump_thread";
    public static final String DIRECT_V2_GENERIC_MESSAGE_PAYLOAD = "/direct_v2/generic_transport_payload";
    ...
    public static final String DIRECT_V2_MARK_AFTER_VIEWED_MESSAGES_SEEN = "/direct_v2/:direct_v2_thread_id/mark_ephemeral_item_ranges_viewed";
    public static final String DIRECT_V2_NICKNAME_SETTING_UPDATE = "/direct_v2/inbox/threads/:direct_v2_thread_id/nicknames_settings";
    public static final String DIRECT_V2_NICKNAME_UPDATE = "/direct_v2/inbox/threads/:direct_v2_thread_id/nicknames";
    public static final String DIRECT_V2_PINNED_MESSAGES_UPDATE = "/direct_v2/threads/:direct_v2_thread_id/pinned_messages_metadata";
    public static final String DIRECT_V2_TAKEDOWN_CHANNELS_METADATA_UPDATE = "/direct_v2/inbox/threads/:direct_v2_thread_id/takedown_data";
    ...
    public static final String DIRECT_V2_THREAD_LAST_DAILY_PROMPT_UPDATE = "/direct_v2/threads/:direct_v2_thread_id/last_daily_prompt";
    ...
    public static final String DIRECT_V2_THREAD_MESSAGE_COUNT_BASED_REACTION_SELF_REACTED_TEMPLATE = "/direct_v2/threads/:direct_v2_thread_id/items/:direct_v2_item_id/batched_reactions_viewer_reaction";
    ...
    public static final String DIRECT_V2_THREAD_MESSAGE_MEDIA_INTERVENTIONS_TEMPLATE = "/direct_v2/threads/:direct_v2_thread_id/items/:direct_v2_item_id/update_media_interventions";
    public static final String DIRECT_V2_THREAD_MESSAGE_MEDIA_MISINFO_TEMPLATE = "/direct_v2/threads/:direct_v2_thread_id/items/:direct_v2_item_id/update_misinfo_treatment";
    ...
    public static final String DIRECT_V2_THREAD_MESSAGE_POLICY_VIOLATION_VISIBILITY_CHANGED_TEMPLATE = "/direct_v2/threads/:direct_v2_thread_id/items/:direct_v2_item_id/policy_violation/visibility";
    ...
    public static final RealtimeProtocol INSTANCE = new Object();
    ...
    public static final String REPLACE_USERS_FRIENDSHIP_STATUS_IS_MESSAGING_ONLY_BLOCKING_TEMPLATE = "/users/:direct_v2_user_id/friendship_status/is_messaging_only_blocking";
    public static final String REPLACE_USERS_FRIENDSHIP_STATUS_MESSAGING_PSEUDO_BLOCKING_TEMPLATE = "/users/:direct_v2_user_id/friendship_status/is_messaging_pseudo_blocking";
