...
public abstract class IGRTCCallManager {
    public static 2LV CONVERTER = new C71545Omg(27);
    ...
    public final class CProxy extends IGRTCCallManager {
        ...
        public native String startCallCopyId(String str, String str2, String str3, ArrayList arrayList, boolean z, boolean z2, String str4, int i, boolean z3, boolean z4, boolean z5, boolean z6, SetupCallback setupCallback, PregenerateSdp pregenerateSdp, OverlayConfigLayerInterface overlayConfigLayerInterface);
    ...
    public abstract String startCallCopyId(String str, String str2, String str3, ArrayList arrayList, boolean z, boolean z2, String str4, int i, boolean z3, boolean z4, boolean z5, boolean z6, SetupCallback setupCallback, PregenerateSdp pregenerateSdp, OverlayConfigLayerInterface overlayConfigLayerInterface);
