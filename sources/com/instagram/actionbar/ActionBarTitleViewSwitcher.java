...
public final class ActionBarTitleViewSwitcher extends ViewAnimator {
    ...
    public final void A03(String str, String str2, boolean z, boolean z2) {
        ...
        if (str2 != null) {
            AnonymousClass3VV r2 = new AnonymousClass3VV(this, str2);
            if (z) {
                duration = 0;
            } else {
                duration = getInAnimation().getDuration();
            }
            postDelayed(r2, duration);
        }
        if (z) {
    ...
    private final void A01(View view) {
        this.A0A = view.requireViewById(R.id.title_text);
    ...
    public ActionBarTitleViewSwitcher(Context context, AttributeSet attributeSet) {
        ...
        this.A0D = true;
        int A032 = AnonymousClass0fD.A03(1766315036);
        AttributeSet attributeSet2 = this.A0I;
        if (attributeSet2 != null) {
            TypedArray obtainStyledAttributes = getContext().getTheme().obtainStyledAttributes(attributeSet2, C71382cm.A00, 0, 0);
            ...
            try {
                ...
                obtainStyledAttributes.recycle();
                AnonymousClass0fD.A0A(-861202984, A032);
                throw th;
            }
        }
        boolean z = this.A0D;
        ...
        if (z) {
            inflate = from.inflate(R.layout.action_bar_title_switcher_logo, this, false);
            ...
            inflate = from.inflate(this.A00, this, false);
            this.A09 = inflate.requireViewById(R.id.title_text);
            this.A04 = (ImageView) inflate.requireViewById(R.id.title_chevron);
        }
        addView(inflate);
        if (!this.A0D || !this.A0B) {
            View inflate2 = LayoutInflater.from(context2).inflate(this.A01, this, false);
            0qQ.A0A(inflate2);
            A01(inflate2);
            addView(inflate2);
            addView(new View(context2), 0, 0);
        } else {
            View inflate3 = LayoutInflater.from(context2).inflate(R.layout.stub_text_title_chevron_container, this, false);
            0qQ.A0C(inflate3, "null cannot be cast to non-null type android.view.ViewStub");
            ViewStub viewStub = (ViewStub) inflate3;
            this.A03 = viewStub;
            if (viewStub == null) {
                0qQ.A0F("secondLabelViewStub");
                throw AnonymousClass00P.createAndThrow();
        ...
        AnonymousClass0fD.A0A(1865418155, A032);
        setInAnimation(this.A0J);
        setOutAnimation(this.A0K);
    }
