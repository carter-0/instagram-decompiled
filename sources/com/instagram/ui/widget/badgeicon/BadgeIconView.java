...
public class BadgeIconView extends View {
    ...
    public final void A01(float f, float f2) {
        float f3 = f2;
        LinearGradient linearGradient = new LinearGradient(0.0f, f3, f, 0.0f, this.A06, (float[]) null, Shader.TileMode.CLAMP);
    ...
    public final void onAttachedToWindow() {
        int A062 = AnonymousClass0fD.A06(369715252);
        super.onAttachedToWindow();
        Drawable drawable = this.A05;
        if (drawable != null) {
            drawable.setCallback(this);
        }
        AnonymousClass0fD.A0D(1087062903, A062);
    }

    public final void onDetachedFromWindow() {
        int A062 = AnonymousClass0fD.A06(-253210578);
        super.onDetachedFromWindow();
        Drawable drawable = this.A05;
        if (drawable != null) {
            drawable.setCallback((Drawable.Callback) null);
        }
        AnonymousClass0fD.A0D(-125706811, A062);
    }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        setTranslationY(((float) getMeasuredHeight()) * this.A04);
    }

    public void setBorderWidth(float f) {
        float A002 = 0nA.A00(getContext(), f);
        if (this.A00 != A002) {
            this.A00 = A002;
            invalidate();
        }
    ...
    public BadgeIconView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.A00 = 0nA.A04(context2, 2);
        int color = context2.getColor(2Yu.A0H(context2, R.attr.igds_color_primary_background));
        this.A07 = color;
