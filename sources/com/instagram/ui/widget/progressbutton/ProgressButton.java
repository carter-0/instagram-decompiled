...
public final class ProgressButton extends FrameLayout {
    ...
    public Integer A01;
    public boolean A02;
    public final ProgressBar A03 = ((ProgressBar) findViewById(R.id.button_progress));
    ...
    public ProgressButton(Context context) {
        super(context);
        0qQ.A0B(context, 1);
        DbV.A0D(this).inflate(R.layout.reg_next, this);
        TextView A0G = DbU.A0G(this, R.id.button_text);
        this.A04 = A0G;
        2eS.A01(A0G);
    }

    private final void setTextSize(int i) {
        this.A04.setTextSize(0, (float) i);
    }

    public final void A00(AttributeSet attributeSet) {
        if (attributeSet != null) {
            Context context = getContext();
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C71382cm.A1p);
            ...
            if (dimensionPixelSize2 != -1) {
                ...
                0nA.A0k(textView2, dimensionPixelSize2, textView2.getPaddingTop(), dimensionPixelSize2, textView2.getPaddingBottom());
            }
    ...
    public final void setProgressBarColor(int i) {
        AnonymousClass7TE.A1R(this.A03.getIndeterminateDrawable().mutate(), i);
    }
    ...
    public final void setTypeface(int i) {
        this.A04.setTypeface((Typeface) null, i);
    }
