...
public class FittingTextView extends IgView {
    ...
    public FittingTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.A09 = num;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C71382cm.A0n, 0, 0);
        ...
        if (resourceId != 0) {
            ...
            float f = this.A00;
            textPaint.setTextSize(f <= 0.0f ? (float) getResources().getDimensionPixelSize(R.dimen.font_large) : f);
            ...
            0oh.A06(context, typeface, textPaint, num);
            this.A0A = textPaint;
            A00();
            return;
        }
