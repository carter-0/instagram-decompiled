...
public class ReelViewerConfig implements Parcelable {
    public static final Parcelable.Creator CREATOR = new C376399Hv(43);
    ...
    public static ReelViewerConfig A00() {
        return new ReelViewerConfig(new AnonymousClass32D());
    }
    ...
    public ReelViewerConfig(Parcel parcel) {
        ...
        this.A0I = parcel.readByte() == 0 ? false : z;
        this.A01 = (Integer) parcel.readValue(Integer.class.getClassLoader());
    }

    public ReelViewerConfig(AnonymousClass32D r3) {
        this.A02 = r3.A03;
        this.A08 = false;
        this.A0C = false;
        this.A0A = false;
