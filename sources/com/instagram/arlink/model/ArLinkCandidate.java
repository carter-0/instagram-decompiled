...
public class ArLinkCandidate {
    ...
    public float getRotationDegree() {
        if (!this.mTextBoxes.isEmpty()) {
            return ((ArLinkTextBox) AnonymousClass7TE.A13(this.mTextBoxes)).mRotationDegree;
        }
        return 0.0f;
    }
    ...
    public RectF getTextRect() {
        ...
        RectF rectF = new RectF(((ArLinkTextBox) AnonymousClass7TE.A13(this.mTextBoxes)).mTextRect);
