...
public class ChipGroup extends C14716U3j {
    public int A00;
    public boolean A01;
    public boolean A02;
    public boolean A03;
    ...
    public List getCheckedChipIds() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if ((childAt instanceof Chip) && ((CompoundButton) childAt).isChecked()) {
                AnonymousClass7TF.A1M(arrayList, childAt.getId());
                if (this.A03) {
                    break;
                }
            }
    ...
    public void setOnCheckedChangeListener(X19 x19) {
        this.A06 = x19;
    }
    ...
    public ChipGroup(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        /*
            r10 = this;
            r9 = 2132018522(0x7f14055a, float:1.9675353E38)
            r5 = r12
            r8 = r13
            android.content.Context r0 = X.C297835sR.A00(r11, r12, r13, r9)
            r10.<init>(r0, r12, r13)
            r3 = 0
            r10.A03 = r3
            android.content.res.Resources$Theme r1 = r0.getTheme()
            int[] r0 = X.C297865sU.A0F
            ...
            int[] r6 = X.C297865sU.A07
            int[] r7 = new int[r3]
            android.content.res.TypedArray r4 = X.C297855sT.A00(r4, r5, r6, r7, r8, r9)
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        if (!super.checkLayoutParams(layoutParams) || !(layoutParams instanceof U3g)) {
            return false;
        }
        return true;
    }
    ...
    public final void onFinishInflate() {
        int A062 = AnonymousClass0fD.A06(119273414);
        ...
        AnonymousClass0fD.A0D(1201006695, A062);
    }
