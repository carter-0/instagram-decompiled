...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    public static final Parcelable.Creator CREATOR = new C376409Hw(40);
    public Account A00;
    public Bundle A01;
    public IBinder A02;
    public String A03;
    ...
    public GetServiceRequest(Account account, Bundle bundle, IBinder iBinder, String str, String str2, Feature[] featureArr, Feature[] featureArr2, Scope[] scopeArr, int i, int i2, int i3, int i4, boolean z, boolean z2) {
        ...
        if (i >= 2) {
            ...
            IAccountAccessor A002 = AccountAccessor.A00(iBinder);
            account = null;
            if (A002 != null) {
                long clearCallingIdentity = Binder.clearCallingIdentity();
                try {
                    zzw zzw = (zzw) A002;
                    int A032 = AnonymousClass0fD.A03(-614451690);
                    Parcel A022 = zzw.A02(zzw.A01(), 2);
                    Parcelable.Creator creator = Account.CREATOR;
                    if (A022.readInt() == 0) {
                        parcelable = null;
                    } else {
                        parcelable = (Parcelable) creator.createFromParcel(A022);
                    }
                    Account account2 = (Account) parcelable;
                    A022.recycle();
                    AnonymousClass0fD.A0A(-404792422, A032);
                    account = account2;
