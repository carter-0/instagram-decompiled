...
public class RetrieveBytesRequest extends AbstractSafeParcelable {
    public static final Parcelable.Creator CREATOR = SWX.A00(15);
    ...
    public RetrieveBytesRequest(List list, boolean z) {
        if (z) {
            ...
            AnonymousClass3Qk.A09(z2, "retrieveAll was set to true but other constraint(s) was also provided: keys");
        }
        this.A01 = z;
