...
public class SharedCamera {
    ...
    public final XnA A02 = new XnA((byte[]) null);
    ...
    public static void A0A(SharedCamera sharedCamera) {
        ...
        ImageReader nativeSharedCameraGetImageReader = sharedCamera.nativeSharedCameraGetImageReader(j, xnA.A01);
        if (nativeSharedCameraGetImageReader != null) {
            nativeSharedCameraGetImageReader.setOnImageAvailableListener(ALG.A00, sharedCamera.A00);
        }
        ImageReader nativeSharedCameraGetImageReaderMotionTracking = sharedCamera.nativeSharedCameraGetImageReaderMotionTracking(session.nativeWrapperHandle, xnA.A01);
        if (nativeSharedCameraGetImageReaderMotionTracking != null) {
            nativeSharedCameraGetImageReaderMotionTracking.setOnImageAvailableListener(ALG.A00, sharedCamera.A00);
        }
    }
    ...
    public final ArrayList A0B() {
        ...
        ImageReader nativeSharedCameraGetImageReaderMotionTracking = nativeSharedCameraGetImageReaderMotionTracking(session.nativeWrapperHandle, xnA.A01);
        if (nativeSharedCameraGetImageReaderMotionTracking != null) {
            A1C.add(nativeSharedCameraGetImageReaderMotionTracking.getSurface());
        }
        A1C.add(nativeSharedCameraGetImageReader(session.nativeWrapperHandle, xnA.A01).getSurface());
        return A1C;
    }
}
