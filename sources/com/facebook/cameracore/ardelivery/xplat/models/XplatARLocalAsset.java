...
public final class XplatARLocalAsset {
    ...
    public ARAssetType getARAssetType() {
        XplatAssetType xplatAssetType2 = this.xplatAssetType;
        switch (xplatAssetType2.ordinal()) {
            case 1:
            case 3:
            case 4:
            ...
            default:
                throw AnonymousClass7TF.A0W("unsupported xplat asset type ", xplatAssetType2.name());
        }
    }
