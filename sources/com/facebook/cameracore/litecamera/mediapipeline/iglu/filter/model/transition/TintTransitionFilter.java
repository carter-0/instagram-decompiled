...
public final class TintTransitionFilter implements TransitionFilter {
    public static final Parcelable.Creator CREATOR = new SWS(56);
    public float A00;
    public boolean A01;
    ...
    public final /* bridge */ /* synthetic */ FilterModel deepCopy() {
        TintTransitionFilter tintTransitionFilter = new TintTransitionFilter(new TransformMatrixParams(this.A02), AnonymousClass7TF.A1a(this.A04), AnonymousClass7TF.A1a(this.A03), 0.0f, true);
        tintTransitionFilter.A00 = tintTransitionFilter.A00;
        tintTransitionFilter.A01 = tintTransitionFilter.A01;
        return tintTransitionFilter;
    }
    ...
    public TintTransitionFilter(TransformMatrixParams transformMatrixParams, float[] fArr, float[] fArr2, float f, boolean z) {
