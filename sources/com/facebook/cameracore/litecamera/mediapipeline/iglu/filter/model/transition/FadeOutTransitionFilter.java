...
public final class FadeOutTransitionFilter implements TransitionFilter {
    public static final Parcelable.Creator CREATOR = new SWS(49);
    public float A00;
    public boolean A01;
    ...
    public final /* bridge */ /* synthetic */ FilterModel deepCopy() {
        FadeOutTransitionFilter fadeOutTransitionFilter = new FadeOutTransitionFilter(new TransformMatrixParams(this.A02), AnonymousClass7TF.A1a(this.A04), AnonymousClass7TF.A1a(this.A03), 0.0f, true);
        fadeOutTransitionFilter.A00 = fadeOutTransitionFilter.A00;
        fadeOutTransitionFilter.A01 = fadeOutTransitionFilter.A01;
        return fadeOutTransitionFilter;
    }
    ...
    public FadeOutTransitionFilter(TransformMatrixParams transformMatrixParams, float[] fArr, float[] fArr2, float f, boolean z) {
    ...
    public FadeOutTransitionFilter() {
