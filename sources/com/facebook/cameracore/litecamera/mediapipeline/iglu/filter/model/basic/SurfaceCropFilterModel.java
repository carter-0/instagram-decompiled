...
public final class SurfaceCropFilterModel implements FilterModel {
    public static final Parcelable.Creator CREATOR = new C376409Hw(15);
    public float A00;
    public float A01;
    public float A02;
    public int A03;
    ...
    public final class FitTransformParams implements Parcelable {
        public static final Parcelable.Creator CREATOR = new SWS(40);
    ...
    public final class FullTransform implements Parcelable {
        public static final Parcelable.Creator CREATOR = new SWS(41);
        ...
        /* JADX WARNING: type inference failed for: r0v0, types: [com.facebook.cameracore.litecamera.mediapipeline.iglu.filter.model.basic.SurfaceCropFilterModel$FullTransform, java.lang.Object] */
    ...
    public SurfaceCropFilterModel(PointF pointF, FitTransformParams fitTransformParams, FullTransform fullTransform, FullTransform fullTransform2, TransformSteps transformSteps, TransformMatrixParams transformMatrixParams, Matrix4 matrix4, Matrix4 matrix42, Matrix4 matrix43, String str, float[] fArr, float[] fArr2, float f, float f2, float f3, int i, int i2, int i3, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8) {
        0qQ.A0B(fullTransform, 1);
        0qQ.A0B(fullTransform2, 3);
        0qQ.A0B(matrix4, 8);
        0qQ.A0B(matrix42, 9);
        0qQ.A0B(matrix43, 10);
        0qQ.A0B(transformSteps, 11);
        0qQ.A0B(pointF, 17);
        0qQ.A0B(fitTransformParams, 18);
        0qQ.A0B(str, 22);
        0qQ.A0B(fArr, 23);
        0qQ.A0B(fArr2, 24);
        0qQ.A0B(transformMatrixParams, 25);
    ...
    public final class TransformSteps implements Parcelable {
        public static final Parcelable.Creator CREATOR = new SWS(42);
        public boolean A00;
        public boolean A01;
        public boolean A02;
        public boolean A03;
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [com.facebook.cameracore.litecamera.mediapipeline.iglu.filter.model.basic.SurfaceCropFilterModel$FitTransformParams, java.lang.Object] */
    public final /* bridge */ /* synthetic */ FilterModel deepCopy() {
        FullTransform A002 = this.A06.A00();
        boolean z = this.A0G;
        FullTransform A003 = this.A0J.A00();
        boolean z2 = this.A0E;
        boolean z3 = this.A0F;
        boolean z4 = this.A0A;
        int i = this.A03;
        ...
        0qQ.A07(copyOf2);
        return new SurfaceCropFilterModel(pointF2, obj, A002, A003, transformSteps2, new TransformMatrixParams(this.A0L), matrix4, matrix42, matrix43, str, copyOf, copyOf2, f, f2, f3, i, i2, i3, z, z2, z3, z4, z5, z6, z7, this.A0B);
    }
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [com.facebook.cameracore.litecamera.mediapipeline.iglu.filter.model.basic.SurfaceCropFilterModel$FullTransform, java.lang.Object] */
    /* JADX WARNING: type inference failed for: r5v0, types: [com.facebook.cameracore.litecamera.mediapipeline.iglu.filter.model.basic.SurfaceCropFilterModel$FullTransform, java.lang.Object] */
    /* JADX WARNING: type inference failed for: r3v0, types: [com.facebook.cameracore.litecamera.mediapipeline.iglu.filter.model.basic.SurfaceCropFilterModel$FitTransformParams, java.lang.Object] */
