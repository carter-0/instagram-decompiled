...
public final class GlitchTransitionFilter implements TransitionFilter {
    public static final Parcelable.Creator CREATOR = new SWS(51);
    public float A00;
    public boolean A01;
    ...
    public GlitchTransitionFilter(TransformMatrixParams transformMatrixParams, float[] fArr, float[] fArr2, float f, boolean z) {
        0qQ.A0B(fArr, 2);
        0qQ.A0B(fArr2, 3);
    ...
    public final /* bridge */ /* synthetic */ FilterModel deepCopy() {
        ...
        0qQ.A07(copyOf2);
        GlitchTransitionFilter glitchTransitionFilter = new GlitchTransitionFilter(new TransformMatrixParams(this.A02), copyOf, copyOf2, 0.0f, true);
        glitchTransitionFilter.A00 = glitchTransitionFilter.A00;
        glitchTransitionFilter.A01 = glitchTransitionFilter.A01;
        return glitchTransitionFilter;
    }
    ...
    public GlitchTransitionFilter() {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.cameracore.litecamera.mediapipeline.iglu.filter.model.transition.GlitchTransitionFilter.<init>():void");
    }
}
