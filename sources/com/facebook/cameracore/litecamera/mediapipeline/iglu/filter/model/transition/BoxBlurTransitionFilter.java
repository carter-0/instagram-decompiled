...
public final class BoxBlurTransitionFilter implements TransitionFilter {
    public static final Parcelable.Creator CREATOR = new SWS(46);
    public float A00;
    public boolean A01;
    ...
    public final /* bridge */ /* synthetic */ FilterModel deepCopy() {
        BoxBlurTransitionFilter boxBlurTransitionFilter = new BoxBlurTransitionFilter(new TransformMatrixParams(this.A02), AnonymousClass7TF.A1a(this.A04), AnonymousClass7TF.A1a(this.A03), 0.0f, true);
        boxBlurTransitionFilter.A00 = boxBlurTransitionFilter.A00;
        boxBlurTransitionFilter.A01 = boxBlurTransitionFilter.A01;
        return boxBlurTransitionFilter;
    }
    ...
    public BoxBlurTransitionFilter(TransformMatrixParams transformMatrixParams, float[] fArr, float[] fArr2, float f, boolean z) {
    ...
    public BoxBlurTransitionFilter() {
