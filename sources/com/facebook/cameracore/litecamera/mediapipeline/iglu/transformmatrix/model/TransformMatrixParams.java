...
public final class TransformMatrixParams implements Parcelable {
    public static final Parcelable.Creator CREATOR = new C376409Hw(20);
    public float A00;
    public float A01;
    public float A02;
    public float A03;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(AAD.A01(this.A06));
        parcel.writeString(AAD.A01(this.A05));
    }
    ...
    public final int hashCode() {
        ...
        return (((((((((((i * 31) + Float.floatToIntBits(this.A01)) * 31) + Float.floatToIntBits(this.A00)) * 31) + Float.floatToIntBits(this.A02)) * 31) + Float.floatToIntBits(this.A03)) * 31) + AAD.A01(num).hashCode() + num.intValue()) * 31) + AAD.A01(num2).hashCode() + num2.intValue();
    }
    ...
    public final String toString() {
        ...
        sb.append(AAD.A01(this.A06));
        sb.append("\ncontentTransformTarget ");
        sb.append(AAD.A01(this.A05));
        sb.append(10);
        return sb.toString();
    }
