...
public final class AREngineController {
    public static final C392689vD Companion = new Object();
    ...
    public final boolean renderSessionInit(boolean z, C368568sr r9, int i, GPUTimerImpl gPUTimerImpl, HybridLogSink hybridLogSink, boolean z2) {
        GPUTimerImpl gPUTimerImpl2 = null;
        if (gPUTimerImpl != null) {
            gPUTimerImpl2 = gPUTimerImpl;
        }
        return renderSessionInit(z, r9.A00, i, gPUTimerImpl2, (HybridLogSink) null, z2);
    }
    ...
    public AREngineController(AssetManager assetManager, AndroidAsyncExecutorFactory androidAsyncExecutorFactory, AndroidAsyncExecutorFactory androidAsyncExecutorFactory2, PluginConfigProvider pluginConfigProvider) {
        AnonymousClass7TG.A1U(assetManager, androidAsyncExecutorFactory, androidAsyncExecutorFactory2);
        synchronized (Companion) {
            if (!isLibraryLoaded) {
                isLibraryStartLoading = true;
                0dV.A0C("filters-native-android");
