    ...
    public abstract class Stub extends Binder implements AutofillContactDataCallback {
        ...
        public final class Proxy implements AutofillContactDataCallback {
            ...
            public final void Czu(List list) {
                int A03 = AnonymousClass0fD.A03(217903108);
                ...
                try {
                    ...
                    obtain.recycle();
                    AnonymousClass0fD.A0A(955285902, A03);
                }
            }

            public final IBinder asBinder() {
                int A03 = AnonymousClass0fD.A03(2097453670);
                IBinder iBinder = this.A00;
                AnonymousClass0fD.A0A(956006122, A03);
                return iBinder;
            }
        }

        public Stub() {
            int A03 = AnonymousClass0fD.A03(277936071);
            attachInterface(this, "com.facebook.browser.lite.ipc.AutofillContactDataCallback");
            AnonymousClass0fD.A0A(1177855588, A03);
        }

        public final IBinder asBinder() {
            AnonymousClass0fD.A0A(595727461, AnonymousClass0fD.A03(340444089));
            return this;
        }

        public final boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            int i3;
            int A03 = AnonymousClass0fD.A03(1068407367);
            if (i >= 1) {
                if (i <= 16777215) {
                    parcel.enforceInterface("com.facebook.browser.lite.ipc.AutofillContactDataCallback");
                    if (i == 1) {
                        Czu(parcel.createStringArrayList());
                        i3 = 1681541556;
                    }
            ...
            AnonymousClass0fD.A0A(-812655039, A03);
            return onTransact;
        }
    }
