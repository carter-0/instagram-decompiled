...
public class GraphQLQueryBuilder {
    ...
    public GraphQLQueryBuilder(RLU rlu, String str, String str2, long j, NativeMap nativeMap, Class cls, int i, GraphServiceAsset graphServiceAsset, boolean z) {
        0fh.A03("GraphQLQueryBuilder(%s)", str2, 2067294751);
        GraphQLConfigHintsJNI graphQLConfigHintsJNI = GraphQLConfigHintsJNI.$redex_init_class;
        throw AnonymousClass7TE.A11("cacheTtlSeconds");
    }
}
