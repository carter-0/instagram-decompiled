...
public class HTTPClient implements NativeHandle {
    ...
    public class Builder {
        ...
        public Builder setCloseStaleSessionsDelayMs(int i) {
            if (isValidOrReportUnexpectedError("closeStaleSessionsDelayMs", (long) i, 0, 30000)) {
        ...
        public Builder setDnsCacheTtlSecs(int i) {
            if (i == 0 || isValidOrReportUnexpectedError("dnsCacheTtlSecs", (long) i, 30, 604800)) {
        ...
        public Builder setDnsMaxRetries(int i) {
            if (isValidOrReportUnexpectedError("dnsMaxRetries", (long) i, 0, 4)) {
        ...
        public Builder setFlowControl(boolean z, int i, int i2) {
            if (isValidOrReportUnexpectedError("sessionFlowControlWindowSize", (long) i, 65535, 2147483647L) && isValidOrReportUnexpectedError("streamFlowControlWindowSize", (long) i2, 65535, 2147483647L)) {
        ...
        public Builder setMaxIdleHTTP2Sessions(int i) {
            if (isValidOrReportUnexpectedError("maxIdleHTTP2Sessions", (long) i, 1, 2)) {
        ...
        public Builder setSessionManagerConnectTimeoutExtra(int i) {
            if (isValidOrReportUnexpectedError("sessionManagerConnectTimeoutExtra", (long) i, 0, 2000)) {
        ...
        public Builder setTcpNotsentLowat(int i) {
            if (isValidOrReportUnexpectedError("tcpNotsentLowat", (long) i, 32768, 32768)) {
        ...
        private boolean isValidOrReportUnexpectedError(String str, long j, long j2, long j3) {
            ...
            A1A.append(" min: ");
            A1A.append(j2);
            unexpectedErrorReporter.report("Invalid Liger Android setting input", Pxg.A0u(" max: ", A1A, j3));
            return false;
        }
        ...
        public HTTPClient build() {
            ...
            throw AnonymousClass7TE.A11("You must call setRootCACallbacks().");
        }
    ...
    public void make(JniHandler jniHandler, NativeReadBuffer nativeReadBuffer, TraceEventContext traceEventContext) {
        ...
        make(jniHandler2, nativeReadBuffer2, traceEventContext.mSamplePolicy.isSampled(), traceEventContext, this.mNetworkStatusMonitor, i, this.mBidirectionalStreamingEnabled);
    }
    ...
    public HTTPClient setIsSandbox(boolean z) {
        if (this.mIsSandbox != z) {
            this.mReInitToRefreshSettings = true;
            this.mIsSandbox = z;
            this.mReInitReason = 002.A1D("sandbox setting changed: ", z);
        }
        return this;
    }
    ...
    public HTTPClient setProxyDomainsRules(String str, String str2) {
        ...
        this.mBypassProxyDomains = str2;
        this.mReInitToRefreshSettings = true;
        this.mReInitReason = 002.A0u("secure proxy domains rules changed: allowDomains=", str, ", bypassDomains=", str2);
        return this;
    }
    ...
    public HTTPClient setProxy(String str, int i, String str2, String str3) {
        ...
        this.mReInitToRefreshSettings = true;
        StringBuilder A1A = AnonymousClass7TE.A1A();
        A1A.append("proxy settings changed: proxy host: ");
        A1A.append(workaroundSamsungLocalProxyBug);
        A1A.append(", proxy port: ");
        A1A.append(i);
        this.mReInitReason = Pxg.A0s(", proxy username: ", str2, A1A);
        return this;
    }
    ...
    public HTTPClient setSecureProxy(String str, int i, String str2, String str3) {
        ...
        this.mReInitToRefreshSettings = true;
        StringBuilder A1A = AnonymousClass7TE.A1A();
        A1A.append("secure proxy settings changed: proxy host: ");
        A1A.append(workaroundSamsungLocalProxyBug);
        A1A.append(", proxy port: ");
        A1A.append(i);
        this.mReInitReason = Pxg.A0s(", proxy username: ", str2, A1A);
