...
public final class EglCore {
            ...
            if (EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                ...
                if (eGLContext2 == EGL14.EGL_NO_CONTEXT) {
                    ...
                    if (!EGL14.eglChooseConfig(this.A02, new int[]{12324, 8, 12323, 8, 12322, 8, 12321, 8, 12352, 4, 12344, 0, 12344}, 0, eGLConfigArr, 0, 1, new int[1], 0)) {
                        0KC.A0P("com.facebook.live.livestreaming.opengl.EglCore", "unable to find RGB8888 /%d EGLConfig", AnonymousClass7TF.A1b(2));
                    } else {
                    ...
                    throw new RuntimeException(C273654mx.A00(517));
                }
    ...
    public final void finalize() {
        if (this.A02 != EGL14.EGL_NO_DISPLAY) {
            0KC.A0D("com.facebook.live.livestreaming.opengl.EglCore", C273654mx.A00(1416));
            A00();
        }
    }
}
