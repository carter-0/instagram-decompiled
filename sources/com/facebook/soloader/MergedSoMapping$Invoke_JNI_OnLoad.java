...
public class MergedSoMapping$Invoke_JNI_OnLoad {
    public static native int libComponentLoggerPluginMCFBridgejni_so();

    public static native int libIGAdvancedCryptoTransportReinstallDataProviderPluginjni_so();

    public static native int libIGBackupUpdateGeneratorPluginImpljni_so();

    public static native int libIGConnectionContextProviderPluginjni_so();

    public static native int libIGDAndroidMsysMultiwaydPluginjni_so();

    public static native int libIGDirectAndroidDBMetricsExperimentsMobileConfigPluginjni_so();

    public static native int libIGDirectAndroidMCIAppExperimentsPluginjni_so();

    public static native int libIGDirectAndroidMCIDBErrorPluginjni_so();

    public static native int libIGDirectAndroidPremailboxExperimentSyncPluginjni_so();

    public static native int libIGInstamadilloPayloadHandlerPluginImpljni_so();

    public static native int libIGPayloadCodecProviderImpljni_so();

    public static native int libIgnitionSyncManagerSchemaDeployer_acg_so();

    public static native int libIgnitionSyncManagerSchemaDeployer_so();

    public static native int libIgnitionSyncManagerSchemaDeployernovt_so();

    public static native int libInstagramAdapterPluginjni_so();

    public static native int libInstagramDasmConfigCreator_jni_so();

    public static native int libMCIBootstrapAttributionLoggerjni_so();

    public static native int libMCIS2SLoggerPluginjni_so();

    public static native int libMEMMobileConfigPlatformIgdAndroidPluginjni_so();
    ...
    public static native int libMessengerCoreCryptoMCFBridgejni_so();

    public static native int libMessengerEchoQueriesCQLTestHelpers_so();

    public static native int libMessengerEncryptedMessagingCQLModelsMCFBridgejni_so();
    ...
    public static native int libMessengerEncryptedMessagingMCFBridgejni_so();
    ...
    public static native int libMsysApplicationInfoPluginjni_so();
    ...
    public static native int lib_bandwidth_estimator_so();

    public static native int lib_request_measurement_so();

    public static native int libachilles_jni_so();

    public static native int libactbackgroundsyncdaemonjni_so();
    ...
    public static native int libarpersistenceserviceipc_so();

    public static native int libarthook_so();

    public static native int libarvr_libraries_avatar_stable_branches_v29_Libraries_avatar_live_editing_avatar_live_editing_min_size_so();
    ...
    public static native int libbandwidth_estimator_jni_so();

    public static native int libbatch_box_cox_ops_xplat_so();

    public static native int libbufferimageloader_so();

    public static native int libbundled_input_image_decoder_ops_xplat_so();

    public static native int libcache_key_generator_jni_so();

    public static native int libchatdutils_so();
    ...
    public static native int libcomfacebookmillaibotsdirectsqlnativeopsjni_so();
    ...
    public static native int libessim_so();
    ...
    public static native int libfbandroid_java_com_facebook_cameracore_mediapipeline_services_voiceinteraction_jni_jni_so();

    public static native int libfbandroid_libraries_profilo_cpp_providers_so();

    public static native int libfbandroid_native_msys_pandoblobjni_util_util_so();
    ...
    public static native int libferrarisadd_xplat_so();

    public static native int libferrariscat_xplat_so();

    public static native int libferrarisglu_xplat_so();

    public static native int libferrarisglubn_xplat_so();

    public static native int libferrarisgru_postprocess_xplat_so();

    public static native int libferrarismul_xplat_so();

    public static native int libferrarissigmoid_xplat_so();

    public static native int libferrarisslice_xplat_so();
    ...
    public static native int libgraphicsengine_ig4a_native_so();
    ...
    public static native int libhttp_interceptor_so();

    public static native int libhybridlogsinkjni_so();

    public static native int libigmobileproberjob_so();

    public static native int libigrequeststream_jni_so();

    public static native int libigtigon_jni_so();

    public static native int libigtigonxplatinterceptorsholder_so();

    public static native int libigtntstigonprovider_so();

    public static native int libigtransientdatacollector_so();

    public static native int libimage_quality_utils_so();
    ...
    public static native int libinstagramencryptedbackup_jni_so();

    public static native int libinstagramreverb_jni_so();
    ...
    public static native int libjni_mcpintegration_mcp_integration_inst_2894329PluginRegistry_so();
    ...
    public static native int libmailboxadvancedcryptotransportpushnotificationsjni_so();
    ...
    public static native int libmailboxinstagrammemjni_so();

    public static native int libmailboxinstagramopenxmareceiverfetchjni_so();

    public static native int libmailboxinstagramportabledbjni_so();

    public static native int libmailboxinstagrampresencejni_so();

    public static native int libmailboxinstagramreverbjni_so();
    ...
    public static native int libmailboxmemcontextjni_so();

    public static native int libmailboxmessengerencryptedbackupsdirectjni_so();

    public static native int libmailboxmessengerencryptedbackupsmemrisjni_so();

    public static native int libmailboxnotificationengineinstagramintegratorjni_so();
    ...
    public static native int libmailboxsecureconsentframeworkstandalonejni_so();
    ...
    public static native int libmodels_core_ig_so();
    ...
    public static native int libmsysInfraMCFBridgejni_so();

    public static native int libmsysInfraMnsMCFBridgejni_so();

    public static native int libmsysInfraNoSqliteMCFBridgejni_so();
    ...
    public static native int libpando_pando_constants_so();

    public static native int libpando_pando_persist_so();

    public static native int libpando_pando_response_cache_so();

    public static native int libpando_realtime_callbacks_so();
    ...
    public static native int libpregensdp_so();
    ...
    public static native int libqlinear_4bit_ops_xplat_so();
    ...
    public static native int librealtime_client_sync_jni_so();

    public static native int librealtimeconfig_so();

    public static native int libreliablemedia_so();

    public static native int librequest_measurement_jni_so();
    ...
    public static native int librschatdtransportsenderapisjni_so();

    public static native int librstransportproxies_so();

    public static native int librsystransportjni_so();

    public static native int librtgql_dgw_connection_so();
    ...
    public static native int libscene_understanding_recognizer_android_so();
    ...
    public static native int libwamsysjni_so();
    ...
    public static native int libxplat_arfx_recognizer_jni_event_listener_event_listenerAndroid_so();
    ...
    public static native int libxplat_assistant_voicesdk_v1_android_voicesdkandroidthreadAndroid_so();
