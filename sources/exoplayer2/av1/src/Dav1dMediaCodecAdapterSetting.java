...
public class Dav1dMediaCodecAdapterSetting {
    ...
    public Dav1dMediaCodecAdapterSetting(Dav1dScalingMode dav1dScalingMode, long j, int i, int i2, int i3, int i4, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, VpsEventCallback vpsEventCallback2, boolean z6, boolean z7, int i5, boolean z8, boolean z9, boolean z10, boolean z11, String str, Context context) {
        ...
        this.vpsEventCallback = vpsEventCallback2;
        this.alignLeft = z6;
