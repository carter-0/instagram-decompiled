...
public interface EglBase {
    ...
    public class ConfigBuilder {
        ...
        public ConfigBuilder setOpenGlesVersion(int i) {
            if (i < 1 || i > 3) {
                throw new IllegalArgumentException(002.A0c("OpenGL ES version ", " not supported", i));
            }
        ...
        public int[] createConfigAttributes() {
            ...
            AnonymousClass7TF.A1M(arrayList, 12324);
            arrayList.add(8);
            AnonymousClass7TF.A1M(arrayList, 12323);
            arrayList.add(8);
            AnonymousClass7TF.A1M(arrayList, 12322);
            arrayList.add(8);
            if (this.hasAlphaChannel) {
                AnonymousClass7TF.A1M(arrayList, 12321);
                arrayList.add(8);
            }
            int i = this.openGlesVersion;
            if (i == 2 || i == 3) {
                AnonymousClass7TF.A1M(arrayList, 12352);
                int i2 = 4;
                if (i == 3) {
                    i2 = 64;
                }
                AnonymousClass7TF.A1M(arrayList, i2);
            }
            if (this.supportsPixelBuffer) {
                AnonymousClass7TF.A1M(arrayList, 12339);
                AnonymousClass7TF.A1M(arrayList, 1);
            }
            if (this.isRecordable) {
                AnonymousClass7TF.A1M(arrayList, EglBase.EGL_RECORDABLE_ANDROID);
                AnonymousClass7TF.A1M(arrayList, 1);
            }
            AnonymousClass7TF.A1M(arrayList, 12344);
            int[] iArr = new int[arrayList.size()];
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                iArr[i3] = AnonymousClass7TE.A0M(arrayList.get(i3));
            }
            return iArr;
        }
