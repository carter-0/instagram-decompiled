...
public interface VideoProcessor extends CapturerObserver {
    ...
    public abstract /* synthetic */ class CC {
        public static VideoFrame applyFrameAdaptationParameters(VideoFrame videoFrame, FrameAdaptationParameters frameAdaptationParameters) {
            ...
            return new VideoFrame(videoFrame.buffer.cropAndScale(frameAdaptationParameters.cropX, frameAdaptationParameters.cropY, frameAdaptationParameters.cropWidth, frameAdaptationParameters.cropHeight, frameAdaptationParameters.scaleWidth, frameAdaptationParameters.scaleHeight), videoFrame.rotation, frameAdaptationParameters.timestampNs);
        }
