...
public class PeerConnectionFactory {
    ...
    public class Builder {
        ...
        public Builder setAudioDecoderFactoryFactory(AudioDecoderFactoryFactory audioDecoderFactoryFactory2) {
            ...
            throw AnonymousClass7TE.A0w("PeerConnectionFactory.Builder does not accept a null AudioDecoderFactoryFactory.");
        }
        ...
        public Builder setAudioEncoderFactoryFactory(AudioEncoderFactoryFactory audioEncoderFactoryFactory2) {
            ...
            throw AnonymousClass7TE.A0w("PeerConnectionFactory.Builder does not accept a null AudioEncoderFactoryFactory.");
        }
        ...
        public Builder setAudioProcessingFactory(AudioProcessingFactory audioProcessingFactory2) {
            ...
            throw AnonymousClass7TE.A11("PeerConnectionFactory builder does not accept a null AudioProcessingFactory.");
        }
        ...
        public PeerConnectionFactory createPeerConnectionFactory() {
            ...
            AudioDeviceModule audioDeviceModule2 = this.audioDeviceModule;
            if (audioDeviceModule2 == null) {
                audioDeviceModule2 = new JavaAudioDeviceModule.Builder(ContextUtils.applicationContext).createAudioDeviceModule();
                this.audioDeviceModule = audioDeviceModule2;
            }
            Context context = ContextUtils.applicationContext;
            Options options2 = this.options;
            long nativeAudioDeviceModulePointer = audioDeviceModule2.getNativeAudioDeviceModulePointer();
            ...
            if (audioProcessingFactory2 == null) {
                ...
                createNative = audioProcessingFactory2.createNative();
            }
            ...
            if (networkControllerFactoryFactory2 == null) {
                ...
                createNativeNetworkControllerFactory = networkControllerFactoryFactory2.createNativeNetworkControllerFactory();
            }
            ...
            if (networkStatePredictorFactoryFactory2 == null) {
                ...
                createNativeNetworkStatePredictorFactory = networkStatePredictorFactoryFactory2.createNativeNetworkStatePredictorFactory();
            }
            ...
            return PeerConnectionFactory.nativeCreatePeerConnectionFactory(context, options2, nativeAudioDeviceModulePointer, createNativeAudioEncoderFactory, createNativeAudioDecoderFactory, videoEncoderFactory2, videoDecoderFactory2, createNative, createNative2, createNativeNetworkControllerFactory, createNativeNetworkStatePredictorFactory, j);
        }
        ...
        /* JADX WARNING: type inference failed for: r0v0, types: [org.webrtc.AudioEncoderFactoryFactory, java.lang.Object] */
        /* JADX WARNING: type inference failed for: r0v1, types: [org.webrtc.AudioDecoderFactoryFactory, java.lang.Object] */
        public Builder() {
    ...
    public class InitializationOptions {
        ...
        public class Builder {
            ...
            /* JADX WARNING: type inference failed for: r0v1, types: [org.webrtc.NativeLibraryLoader, java.lang.Object] */
        ...
        public InitializationOptions(Context context, String str, boolean z, NativeLibraryLoader nativeLibraryLoader2, String str2, Loggable loggable2, Logging.Severity severity) {
            this.applicationContext = context;
            this.fieldTrials = str;
            this.enableInternalTracer = z;
            this.nativeLibraryLoader = nativeLibraryLoader2;
    ...
    public class ThreadInfo {
        ...
        public ThreadInfo(Thread thread2, int i) {
            this.thread = thread2;
            this.tid = i;
        }
    ...
    private void checkPeerConnectionFactoryExists() {
        if (this.nativeFactory == 0) {
            throw AnonymousClass7TE.A0z("PeerConnectionFactory has been disposed.");
        }
    }
    ...
    public PeerConnection createPeerConnection(List list, PeerConnection.Observer observer) {
        return createPeerConnectionInternal(new PeerConnection.RTCConfiguration(list), (MediaConstraints) null, observer, (SSLCertificateVerifier) null);
    }
    ...
    public static void checkInitializeHasBeenCalled() {
        if (!NativeLibrary.isLoaded() || ContextUtils.applicationContext == null) {
            throw AnonymousClass7TE.A0z("PeerConnectionFactory.initialize was not called before creating a PeerConnectionFactory.");
        }
    }
    ...
    /* JADX WARNING: type inference failed for: r0v1, types: [org.webrtc.AudioSource, org.webrtc.MediaSource] */
    public AudioSource createAudioSource(MediaConstraints mediaConstraints) {
        checkPeerConnectionFactoryExists();
        return new MediaSource(nativeCreateAudioSource(this.nativeFactory, mediaConstraints));
    }

    /* JADX WARNING: type inference failed for: r0v1, types: [org.webrtc.MediaStreamTrack, org.webrtc.AudioTrack] */
    ...
    public PeerConnection createPeerConnection(List list, MediaConstraints mediaConstraints, PeerConnection.Observer observer) {
        return createPeerConnectionInternal(new PeerConnection.RTCConfiguration(list), mediaConstraints, observer, (SSLCertificateVerifier) null);
    }
    ...
    public PeerConnection createPeerConnection(PeerConnection.RTCConfiguration rTCConfiguration, PeerConnectionDependencies peerConnectionDependencies) {
        return createPeerConnectionInternal(rTCConfiguration, (MediaConstraints) null, peerConnectionDependencies.observer, peerConnectionDependencies.sslCertificateVerifier);
    }
    ...
    public PeerConnection createPeerConnection(PeerConnection.RTCConfiguration rTCConfiguration, PeerConnection.Observer observer) {
        return createPeerConnectionInternal(rTCConfiguration, (MediaConstraints) null, observer, (SSLCertificateVerifier) null);
    }
}
