...
public final class YuvConverter {
    ...
    private VideoFrame.I420Buffer convertInternal(VideoFrame.TextureBuffer textureBuffer) {
        ...
        textureBuffer2.getWidth();
        textureBuffer2.getHeight();
        textureBuffer2.retain();
        ...
        try {
            ...
            return JavaI420Buffer.wrap(width, height, slice, i, slice2, i, slice3, i, new YuvConverter$$ExternalSyntheticLambda0(nativeAllocateByteBuffer));
    ...
    public VideoFrame.I420Buffer convert(VideoFrame.TextureBuffer textureBuffer) {
        ...
        try {
            ...
            e = e;
            str = "OOM exception in YuvConverter.convert. Failed to convert TextureBuffer ";
            Logging.w(TAG, str, e);
            return null;
        } catch (GLException e2) {
            e = e2;
            str = "Generic exception in YuvConverter.convert. Failed to convert TextureBuffer";
            Logging.w(TAG, str, e);
            return null;
        } catch (Exception e3) {
            e = e3;
            str2 = "Generic exception in YuvConverter.convert. Rethrowing";
            Logging.e(TAG, str2, e);
            throw e;
        } catch (Error e4) {
            e = e4;
            str2 = "Java Error in YuvConverter.convert. Rethrowing";
            Logging.e(TAG, str2, e);
            throw e;
        }
    }
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [org.webrtc.GlGenericDrawer$ShaderCallbacks, java.lang.Object, org.webrtc.YuvConverter$ShaderCallbacks] */
