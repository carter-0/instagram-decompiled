...
public final class WebRtcAudioUtils {
    ...
    public static void logAudioStateVolume(String str, AudioManager audioManager) {
        ...
        if (!audioManager.isVolumeFixed()) {
            ...
            do {
                ...
                C21055XCg.A1S(C21055XCg.A0S(i2), audioManager, i2, A1A);
                logIsStreamMute(str, audioManager, i2, A1A);
                i++;
            } while (i < 6);
        }
    }
    ...
    public static String audioEncodingToString(int i) {
        ...
        switch (i) {
            ...
            case 9:
                return "MP3";
            default:
                return 002.A0O("Invalid encoding: ", i);
        }
    }
    ...
    public static String getThreadInfo() {
        ...
        A1A.append(currentThread.getName());
        A1A.append(", id=");
        A1A.append(currentThread.getId());
        return AnonymousClass7TF.A0l("]", A1A);
    }

    public static boolean hasMicrophone(Context context) {
        return context.getPackageManager().hasSystemFeature(AnonymousClass000.A00(1086));
    }
