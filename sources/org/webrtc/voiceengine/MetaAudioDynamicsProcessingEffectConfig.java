...
public class MetaAudioDynamicsProcessingEffectConfig {
    ...
    private void reportDynamicProcessingEffectConfigInitError(String str) {
        ...
        nativeReportDynamicProcessingEffectConfigInitError(002.A0R("DP config creation error: ", str), this.nativeDynamicsProcessingEffectConfig);
    }
    ...
    public boolean setMbcAttackTime(int i, float f, boolean z) {
        ...
        if (config2 != null) {
            try {
                DynamicsProcessing.Mbc A03 = C21055XCg.A03(config2);
                if (z) {
    ...
    public boolean setMbcEnabled(boolean z) {
        ...
        if (config2 != null) {
            try {
                C21055XCg.A03(config2).setEnabled(z);
                return true;
            } catch (Exception e) {
    ...
    public MetaAudioDynamicsProcessingEffectConfig(long j) {
        ...
        if (WebRtcAudioEffects.canUseDynamicsProcessing()) {
            try {
                DynamicsProcessing.Config.Builder builder2 = new DynamicsProcessing.Config.Builder(0, 1, true, 8, true, 8, true, 8, true);
                this.builder = builder2;
                builder2.setPreferredFrameDuration(10.0f);
                config = this.builder.build();
            } catch (NoClassDefFoundError e) {
                Logging.e(TAG, "MetaAudioDynamicsProcessingEffectConfig creation encountered NoClassDefFoundError", e);
            } catch (Exception e2) {
                Logging.e(TAG, "MetaAudioDynamicsProcessingEffectConfig failed to create the default config", e2);
