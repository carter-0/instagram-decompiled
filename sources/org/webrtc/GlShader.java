...
public class GlShader {
    ...
    public int getAttribLocation(String str) {
        ...
        if (i != -1) {
            ...
            throw C13989Tnp.A0l("Could not locate '", str);
        }
    ...
    public GlShader(String str, String str2) {
        ...
        throw C13989Tnp.A0k("glCreateProgram() failed. GLES20 error: ", GLES20.glGetError());
    }
    ...
    public static int compileShader(int i, String str) {
        ...
        throw C13989Tnp.A0k("glCreateShader() failed. GLES20 error: ", GLES20.glGetError());
    }
