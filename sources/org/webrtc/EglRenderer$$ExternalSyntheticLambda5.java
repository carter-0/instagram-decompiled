...
public final /* synthetic */ class EglRenderer$$ExternalSyntheticLambda5 implements Runnable {
    ...
    public /* synthetic */ EglRenderer$$ExternalSyntheticLambda5(EglRenderer eglRenderer, RendererCommon.GlDrawer glDrawer, EglRenderer.FrameListener frameListener, float f, boolean z) {
    ...
    public final void run() {
        this.f$0.m35lambda$addFrameListener$1$orgwebrtcEglRenderer(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
