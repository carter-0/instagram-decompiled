...
public class IValue {
        ...
        if (length > 0) {
            ...
            while (i2 < length) {
                if (i == iValueArr[i2].mTypeCode) {
                    ...
                    throw AnonymousClass7TE.A0w("List must contain items of the same type");
                }
            }
        }
    ...
    private void preconditionType(int i, int i2) {
        ...
        if (i2 != i) {
            ...
            throw new IllegalStateException(String.format(locale, "Expected IValue type %s, actual type %s", new Object[]{str, str2}));
        }
    }
    ...
    public boolean isDictLongKey() {
        return AnonymousClass7TF.A1S(14, this.mTypeCode);
    }

    public boolean isDictStringKey() {
        return AnonymousClass7TF.A1S(13, this.mTypeCode);
    }
    ...
    public boolean isDoubleList() {
        return AnonymousClass7TF.A1S(10, this.mTypeCode);
    }

    public boolean isList() {
        return AnonymousClass7TF.A1S(12, this.mTypeCode);
    }
