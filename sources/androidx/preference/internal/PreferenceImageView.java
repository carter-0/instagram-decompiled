...
public class PreferenceImageView extends ImageView {
    ...
    public PreferenceImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C17166VKv.A09, i, 0);
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (mode2 == Integer.MIN_VALUE || mode2 == 0) {
            ...
            if (i4 != Integer.MAX_VALUE && (i4 < size2 || mode2 == 0)) {
                i2 = View.MeasureSpec.makeMeasureSpec(i4, AnonymousClass972.MUTABLE_FLAG_MASK);
            }
        }
