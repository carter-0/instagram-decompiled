...
public final class IC0 implements View.OnClickListener {
    ...
    public IC0(C255783ui r1, C249693kD r2, C317606nX r3, C316846mJ r4) {
        this.A02 = r3;
        this.A01 = r2;
        this.A03 = r4;
        this.A00 = r1;
    ...
    public final void onClick(View view) {
        int A05 = AnonymousClass0fD.A05(-1958761672);
        C317606nX r3 = this.A02;
        1Xj BPf = this.A01.BPf();
        if (BPf != null) {
            C316846mJ r1 = this.A03;
            r3.DRq(BPf, r1, this.A00);
            IgTextView igTextView = r1.A03;
            if (igTextView != null) {
                if (igTextView.isHapticFeedbackEnabled()) {
                    IgTextView igTextView2 = r1.A03;
                    if (igTextView2 != null) {
                        igTextView2.performHapticFeedback(1);
                    }
                }
                AnonymousClass0fD.A0C(-279083158, A05);
                return;
            }
            0qQ.A0F("buttonView");
        ...
        AnonymousClass0fD.A0C(323649111, A05);
        throw A0y;
    }
}
