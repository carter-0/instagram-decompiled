...
public abstract class AnonymousClass6MN {
    public static final void A00(TextView textView, Context context) {
        ...
        layoutParams2.height = context.getResources().getDimensionPixelSize(R.dimen.add_to_story_dual_destination_share_sheet_avatar_icon_size);
