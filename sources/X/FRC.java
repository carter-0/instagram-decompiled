...
public final class FRC implements C13811The {
    ...
    public FRC(Map map, Map map2) {
        this.A00 = map;
        this.A01 = map2;
        this.A02 = new C11844ShW("com.bloks.www.caa.login.aymh.screen_query", (String) null, "CAA_LOGIN_AYMH_PAGE", map, map2, 719983200, 604800, true);
    }
