...
public final class AnonymousClass44V implements C2598643j {
    public final UserSession A00;
    public final 2Dm A01;

    public AnonymousClass44V(UserSession userSession, 2Dm r3) {
        0qQ.A0B(r3, 2);
    ...
    public final AnonymousClass6BN E4Y(AnonymousClass651 r16, AnonymousClass653 r17, List list, Map map, 0sL r20, 0sL r21, boolean z) {
        ...
        try {
            ...
            if (str2 == null) {
                ...
                r7 = C395249zS.parseFromJson(0c9.A04.A01(this.A00, str2));
            }
            2Dr r5 = this.A01;
            ...
            0KC.A0F(simpleName, "Invalid last daily prompt metadata payload", e);
            0qQ.A07(simpleName);
            return new AnonymousClass6BQ(e, simpleName, "Invalid last daily prompt metadata payload");
        }
    }
}
