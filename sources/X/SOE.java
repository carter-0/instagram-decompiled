...
public final class SOE {
    ...
    public static synchronized SOE A00(Context context) {
        SOE soe;
    ...
    public static void A01(X.SOE r3, int r4) {
        /*
        ...
        L_0x002f:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.SOE.A01(X.SOE, int):void");
    }
    ...
    public SOE(Context context) {
        ...
        context.registerReceiver(new Q5v(this), intentFilter);
    }
}
