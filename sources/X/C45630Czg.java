...
public abstract class C45630Czg {
    public static BGY parseFromJson(16F r24) {
        String str;
        16F r2 = r24;
        0qQ.A0B(r2, 0);
        try {
            ...
            return new BGY(stickerTraySurface, subscriptionStickerDict, f, f2, f3, f4, f5, f6, f7, f8, num, num2, num3, num4, num5, str2, str3, str4, str5, str6, str7);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
    ...
    public static void A00(17Z r1, BGY bgy, boolean z) {
        if (z) {
            r1.A0c();
        }
        C41846B3n.A13(r1, bgy.A0F);
        C41846B3n.A16(r1, bgy.A0G);
        C41846B3n.A17(r1, bgy.A0H);
        C41846B3n.A15(r1, bgy.A0I);
        C41846B3n.A0w(r1, bgy.A02);
        C41846B3n.A0u(r1, bgy.A03);
        C41846B3n.A0y(r1, bgy.A0J);
        C41846B3n.A0o(r1, bgy.A0A);
        C41846B3n.A0l(r1, bgy.A0B);
        C41846B3n.A0m(r1, bgy.A0C);
        C41846B3n.A0n(r1, bgy.A0D);
        C41846B3n.A12(r1, bgy.A0K);
        C41846B3n.A0v(r1, bgy.A04);
        C41846B3n.A0x(r1, bgy.A05);
        C41846B3n.A0p(r1, bgy.A0E);
        C41846B3n.A0k(r1, bgy.A01);
        C41846B3n.A0j(r1, bgy.A00);
        C41846B3n.A0t(r1, bgy.A06);
        C41846B3n.A0q(r1, bgy.A07);
        C41846B3n.A0r(r1, bgy.A08);
        C41846B3n.A0s(r1, bgy.A09);
        if (z) {
            r1.A0Z();
        }
    }
