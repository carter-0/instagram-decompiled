...
public final class AnonymousClass0SO extends AnonymousClass0Bt {
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: null in method: X.0SO.A04(X.0Bs):boolean, dex: classes.dex
    ...
    public final /* bridge */ /* synthetic */ boolean A04(X.0Bs r1) {
        /*
        // Can't load method instructions: Load method exception: null in method: X.0SO.A04(X.0Bs):boolean, dex: classes.dex
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass0SO.A04(X.0Bs):boolean");
    }
