...
public abstract class C245353cj {
    public static C245363cl parseFromJson(16F r6) {
        String str;
        0qQ.A0B(r6, 0);
        try {
            if (r6.A11() != 16L.A0D) {
            ...
            if (onboardingEntryActionType != null || !(r6 instanceof 0c9)) {
                return new C245363cl(onboardingEntryActionType);
            }
            ((0c9) r6).A03.A00("action_type", "AppreciationCommentEntryObjectImpl");
