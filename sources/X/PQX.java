...
public final class PQX implements C315616kD {
    ...
    public PQX(C71066Oal oal, RoundedCornerFrameLayout roundedCornerFrameLayout, int i, int i2, int i3, int i4) {
        this.A00 = i;
        this.A02 = i2;
        this.A01 = i3;
        this.A03 = i4;
    ...
    public final void DaF(C294975nL r14, float f) {
        ...
        roundedCornerFrameLayout.setCornerRadius((int) ((float) AnonymousClass37Q.A03(d, 0.0d, (double) 0nA.A04(oal.A06, 20))));
        oal.A07.setAlpha(1.0f - f);
