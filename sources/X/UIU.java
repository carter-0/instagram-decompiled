...
public abstract class UIU extends U1M {
    public int A00;
    public int A01;
    public int A02;
    public int A03;
    ...
    public static void A00(UIU uiu) {
        uiu.A03 = 2;
        int[] iArr = uiu.A09;
        Arrays.fill(iArr, 0);
        iArr[0] = 255;
    ...
    private boolean A01(float f) {
        ...
        for (int i = 0; i < this.A0C.length; i++) {
            ...
            int[] iArr = this.A08;
            int i3 = (int) (((float) this.A09[i]) + (((float) (i2 * 255)) * f));
            iArr[i] = i3;
            if (i3 < 0) {
                iArr[i] = 0;
            }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:42:0x008d A[EDGE_INSN: B:42:0x008d->B:29:0x008d ?: BREAK  , SYNTHETIC] */
    ...
    public final void draw(android.graphics.Canvas r8) {
        ...
        L_0x00ab:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.UIU.draw(android.graphics.Canvas):void");
    }
    ...
    public UIU(Drawable[] drawableArr, int i) {
        super(drawableArr);
