...
public final class C19993WjE implements Runnable {
    public final /* synthetic */ RefreshableRecyclerViewLayout A00;

    public C19993WjE(RefreshableRecyclerViewLayout refreshableRecyclerViewLayout) {
    ...
    public final void run() {
        ...
        try {
            ...
            if (declaredField != null) {
                ...
                if (obj != null) {
                    ...
                    if (cls != null) {
                        ...
                        method = cls.getDeclaredMethod("postFromTraversal", new Class[]{RecyclerView.class, cls2, cls2});
                    } else {
                        method = null;
                    }
            ...
            RefreshableRecyclerViewLayout.A08(this.A00, e, AnonymousClass05K.A00);
        }
    }
}
