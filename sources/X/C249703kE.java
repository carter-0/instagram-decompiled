...
public abstract class C249703kE {
    ...
    public AnonymousClass3AN mScrapContainer = null;
    public C249703kE mShadowedHolder = null;
    public C249703kE mShadowingHolder = null;
    ...
    public final int getAbsoluteAdapterPosition() {
        ...
        return recyclerView.A0S(this);
    }

    public final 2Rw getBindingAdapter() {
    ...
    public final int getBindingAdapterPosition() {
        ...
        2Rw r1;
        int A0S;
        2Rw r3 = this.mBindingAdapter;
        if (r3 == null || (recyclerView = this.mOwnerRecyclerView) == null || (r1 = recyclerView.A0A) == null || (A0S = recyclerView.A0S(this)) == -1) {
            return -1;
        }
        return r1.findRelativeAdapterPositionIn(r3, this, A0S);
    }
    ...
    public void offsetPosition(int i, boolean z) {
        ...
        if (this.itemView.getLayoutParams() != null) {
            ((AnonymousClass3MX) this.itemView.getLayoutParams()).A00 = true;
        }
    }
    ...
    public void setScrapContainer(AnonymousClass3AN r1, boolean z) {
    ...
    public C249703kE(View view) {
        if (view != null) {
            this.itemView = view;
            return;
        }
        throw new IllegalArgumentException(AnonymousClass000.A00(3474));
    }
    ...
    public String toString() {
        ...
        if (!isRecyclable()) {
            sb2.append(002.A0c(" not recyclable(", ")", this.mIsRecyclableCount));
        }
