...
public final class C245213cV {
    ...
    public C245253cZ A0H = C245223cW.A01;
    ...
    public final int hashCode() {
        ...
        int floatToIntBits = (((((((((((((((((((((((((((((color + i) * 31) + Float.floatToIntBits(this.A01)) * 31) + Float.floatToIntBits(this.A02)) * 31) + Float.floatToIntBits(this.A03)) * 31) + this.A09) * 31) + textPaint.linkColor) * 31) + Float.floatToIntBits(textPaint.density)) * 31) + Arrays.hashCode(textPaint.drawableState)) * 31) + this.A0C) * 31) + this.A0B) * 31) + Float.floatToIntBits(this.A05)) * 31) + Float.floatToIntBits(this.A04)) * 31) + Float.floatToIntBits(this.A00)) * 31) + (this.A0J ? 1 : 0)) * 31) + 1) * 31;
        ...
        int hashCode = (((((((floatToIntBits + i2) * 31) + (this.A0M ? 1 : 0)) * 31) + this.A0A) * 31) + this.A0E.hashCode()) * 31;
        C245253cZ r0 = this.A0H;
        if (r0 != null) {
            i3 = r0.hashCode();
        } else {
            i3 = 0;
