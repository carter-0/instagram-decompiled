...
public final class C50344FZb implements B1O {
    ...
    public final void FHp(AnonymousClass3Q2 r4) {
        ...
        if (B3v != null && (fanClubId = B3v.getFanClubId()) != null) {
            r4.A11 = new ClipsFanClubMetadata(C46401DeO.FEEDBACK_STICKER_STORY_FROM_NOTIF, fanClubId);
        }
    }

    public C50344FZb(User user) {
        this.A00 = user;
    }
}
