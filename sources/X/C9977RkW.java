...
public abstract /* synthetic */ class C9977RkW {
    ...
    static {
        /*
            X.RDS[] r0 = X.RDS.values()
            int r0 = r0.length
            int[] r1 = new int[r0]
            X.RDS r0 = X.RDS.A02     // Catch:{ NoSuchFieldError -> 0x000c }
            X.C66581MXm.A1N(r0, r1)     // Catch:{ NoSuchFieldError -> 0x000c }
        L_0x000c:
            X.RDS r0 = X.RDS.A03     // Catch:{ NoSuchFieldError -> 0x0011 }
            X.C51970G9q.A1M(r0, r1)     // Catch:{ NoSuchFieldError -> 0x0011 }
        L_0x0011:
            X.RDS r0 = X.RDS.A04     // Catch:{ NoSuchFieldError -> 0x0016 }
            X.C66581MXm.A1O(r0, r1)     // Catch:{ NoSuchFieldError -> 0x0016 }
        L_0x0016:
            A00 = r1
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C9977RkW.<clinit>():void");
    }
}
