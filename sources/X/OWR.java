...
public final class OWR {
    ...
    public OWR(LightweightQuickPerformanceLogger lightweightQuickPerformanceLogger) {
    ...
    public final void A01(String str) {
        ...
        lightweightQuickPerformanceLogger.markerEnd(1021649468, i, 3);
    }

    public final void A02(String str, int i) {
        LightweightQuickPerformanceLogger lightweightQuickPerformanceLogger = this.A01;
        lightweightQuickPerformanceLogger.markerAnnotate(1021649468, "vesta_client_error_code", i);
        C66583MXo.A1D(lightweightQuickPerformanceLogger, "vesta_client_error", str, 1021649468, this.A00);
    }
}
