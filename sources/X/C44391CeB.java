...
public abstract class C44391CeB {
    public static C42085BGo parseFromJson(16F r26) {
        String str;
        16F r2 = r26;
        0qQ.A0B(r2, 0);
        try {
            ...
            while (r2.A1J() != 16L.A09) {
                ...
                } else if (AnonymousClass000.A00(148).equals(A0q)) {
                    if (r2.A11() == 16L.A0G) {
                        str6 = null;
                    } else {
                        str6 = r2.A1P();
            ...
            return new C42085BGo(stickerTraySurface, subscriptionStickerDict, f, f2, f3, f4, f5, f6, f7, f8, num, num2, num3, num4, num5, str2, str3, str4, str5, str6, str7, str8, str9);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
