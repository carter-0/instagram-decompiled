...
public abstract /* synthetic */ class C44426Cek {
    public static Map A00(AnonymousClass5FO r4) {
        ...
        String str = null;
        if (r4.Bim() != null) {
            C46321DUy Bim = r4.Bim();
            if (Bim != null) {
                treeUpdaterJNI2 = Bim.FHC();
            } else {
                treeUpdaterJNI2 = null;
            }
            A1H.put("question_sticker", treeUpdaterJNI2);
        }
        if (r4.Bof() != null) {
