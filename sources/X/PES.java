...
public final class PES implements C74415PuV {
    ...
    public final void EMg(OH1 oh1) {
        ...
        if (A2A != null) {
            ...
            1a8 r2 = this.A00;
            0qQ.A0B(r2, 10);
            AnonymousClass7TE.A1Z(new C73559PfO(r2, userSession, Bh3, r5, A0c, A2A, "IgtvXmaShareSender", str, str2, (AnonymousClass4D7) null, 1009, A08, 1), DbY.A0r(AnonymousClass12T.A00, 47));
            return;
        }
    ...
    public PES(UserSession userSession) {
