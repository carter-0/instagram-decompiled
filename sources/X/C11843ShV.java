...
public final class C11843ShV implements C13811The {
    ...
    public C11843ShV(Map map, Map map2) {
        this.A00 = map;
        this.A01 = map2;
        this.A02 = new C11844ShW("com.bloks.www.iaw.autofill.payment.usage.screen_query", (String) null, (String) null, map, map2, 772803329, SandboxRepository.CACHE_TTL, true);
    }
