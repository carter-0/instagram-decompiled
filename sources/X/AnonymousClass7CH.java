...
public final class AnonymousClass7CH implements C327687Bu {
    ...
    public final boolean AFS(UserSession userSession, C254703su r4, int i) {
        0qQ.A0B(r4, 1);
        if (r4.A2P || AnonymousClass48O.A04(i)) {
            return false;
        }
        return true;
    }
