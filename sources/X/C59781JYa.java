...
public final class C59781JYa implements Callable {
    public final /* synthetic */ 1WY A00;
    public final /* synthetic */ 2NU A01;

    public C59781JYa(1WY r1, 2NU r2) {
        this.A01 = r2;
        this.A00 = r1;
    }
    ...
    public final /* bridge */ /* synthetic */ Object call() {
        ...
        String string3;
        2NU r14 = this.A01;
        C251983oI r157 = r14.A02;
        r157.beginTransaction();
        try {
            1WY r0 = this.A00;
            r156 = r0;
            query = r157.query((AnonymousClass1WA) r0, (CancellationSignal) null);
            ...
            if (query.moveToFirst()) {
                String string4 = query.getString(A012);
                ...
                boolean A1P = AnonymousClass7TF.A1P(query.getInt(A018));
                ...
                String string5 = query.getString(A0119);
                if (query.isNull(A0120)) {
                    str9 = null;
                } else {
                    str9 = query.getString(A0120);
                }
                boolean A1P2 = AnonymousClass7TF.A1P(query.getInt(A0121));
                ...
                if (query.isNull(A0125)) {
                    ...
                    r104 = 2NU.A00(query.getString(A0125));
                }
                ...
                boolean A1P3 = AnonymousClass7TF.A1P(query.getInt(A0134));
                ...
                if (query.isNull(A0140) || (string3 = query.getString(A0140)) == null) {
                    r97 = null;
                } else {
                    try {
                        r97 = C357588Yu.valueOf(string3);
                    } catch (IllegalArgumentException unused) {
                        r97 = null;
                    }
                }
                if (query.isNull(A0141) || (string2 = query.getString(A0141)) == null) {
                    r99 = null;
                } else {
                    try {
                        r99 = C394889yr.parseFromJson(16P.A00(string2));
                ...
                boolean A1P4 = AnonymousClass7TF.A1P(query.getInt(A0143));
                if (query.isNull(A0144)) {
                    str21 = null;
                } else {
                    str21 = query.getString(A0144);
                }
                C63815L7w A0016 = JUY.A00(str21);
                if (query.isNull(A0145)) {
                    str22 = null;
                } else {
                    str22 = query.getString(A0145);
                }
                C61062Jw0 A0017 = JUX.A00(str22);
                boolean A1P5 = AnonymousClass7TF.A1P(query.getInt(A0146));
                boolean A1P6 = AnonymousClass7TF.A1P(query.getInt(A0147));
                boolean A1P7 = AnonymousClass7TF.A1P(query.getInt(A0148));
                boolean A1P8 = AnonymousClass7TF.A1P(query.getInt(A0149));
                boolean A1P9 = AnonymousClass7TF.A1P(query.getInt(A0150));
                List A01102 = JUT.A01(query.getString(A0151));
                List A0018 = JUU.A00(query.getString(A0152));
                if (query.isNull(A0153)) {
                    str23 = null;
                } else {
                    str23 = query.getString(A0153);
                }
                int i = query.getInt(A0154);
                boolean A1P10 = AnonymousClass7TF.A1P(query.getInt(A0155));
                if (query.isNull(A0156)) {
                    str24 = null;
                } else {
                    str24 = query.getString(A0156);
                }
                if (query.isNull(A0157)) {
                    str25 = null;
                } else {
                    str25 = query.getString(A0157);
                }
                if (query.isNull(A0158)) {
                    str26 = null;
                } else {
                    str26 = query.getString(A0158);
                }
                C61000Juw A0019 = JUZ.A00(str26);
                if (query.isNull(A0159)) {
                    str27 = null;
                } else {
                    str27 = query.getString(A0159);
                }
                C61100JxB A0020 = C59694JUb.A00(str27);
                if (query.isNull(A0160)) {
                    str28 = null;
                } else {
                    str28 = query.getString(A0160);
                }
                C61080JwI A0021 = C59693JUa.A00(str28);
                boolean A1P11 = AnonymousClass7TF.A1P(query.getInt(A0161));
                if (query.isNull(A0162) || (string = query.getString(A0162)) == null) {
                    mediaGenAIDetectionMethod = null;
                } else {
                    mediaGenAIDetectionMethod = C252913pu.A00(string);
                }
                boolean A1P12 = AnonymousClass7TF.A1P(query.getInt(A0163));
                boolean A1P13 = AnonymousClass7TF.A1P(query.getInt(A0164));
                if (!query.isNull(A0165) || !query.isNull(A0166) || !query.isNull(A0167) || !query.isNull(A0168)) {
                    r87 = new C381689cA(2, query.getFloat(A0165), query.getFloat(A0166), query.getFloat(A0167), query.getFloat(A0168));
                } else {
                    r87 = null;
                }
                if (!query.isNull(A0169) || !query.isNull(A0170) || !query.isNull(A0171) || !query.isNull(A0172) || !query.isNull(A0173) || !query.isNull(A0174) || !query.isNull(A0175) || !query.isNull(A0176) || !query.isNull(A0177) || !query.isNull(A0178) || !query.isNull(A0179) || !query.isNull(A0180) || !query.isNull(A0181) || !query.isNull(A0182) || !query.isNull(A0183) || !query.isNull(A0184) || !query.isNull(A0185) || !query.isNull(A0186) || !query.isNull(A0187) || !query.isNull(A0188) || !query.isNull(A0189) || !query.isNull(A0190) || !query.isNull(A0191)) {
                    String string6 = query.getString(A0169);
                    if (query.isNull(A0170)) {
                        str31 = null;
                    } else {
                        str31 = query.getString(A0170);
                    }
                    RectF A0022 = LPY.A00(str31);
                    query.getInt(A0171);
                    query.getInt(A0172);
                    ...
                    if (query.isNull(A0174)) {
                        ...
                        str32 = query.getString(A0174);
                    }
                    IGTVShoppingMetadata A0023 = LJ7.A00(str32);
                    query.getInt(A0175);
                    query.getInt(A0176);
                    query.getInt(A0177);
                    query.getInt(A0178);
                    ...
                    if (query.isNull(A0185)) {
                        ...
                        str33 = query.getString(A0185);
                    }
                    IGTVBrandedContentTags A0024 = LPZ.A00(str33);
                    query.getInt(A0186);
                    query.getInt(A0187);
                    query.getInt(A0188);
                    query.getInt(A0189);
                    ...
                    query.getInt(A0191);
                    lms = new LMS(A0022, A0024, A0023, string6);
                } else {
                    lms = null;
                }
                if (!query.isNull(A0192) || !query.isNull(A0193) || !query.isNull(A0194)) {
                    ...
                    if (query.isNull(A0194)) {
                        ...
                        str30 = query.getString(A0194);
                    }
                    RectF A0025 = JUT.A00(str30);
                    if (A0025 != null) {
                        r2 = new C381639c5(A0025, i2, i3);
                    } else {
                        throw AnonymousClass7TE.A0z(C273654mx.A00(483));
                    }
                } else {
                    r2 = null;
                }
                ...
                if (query.isNull(A0196)) {
                    ...
                    str29 = query.getString(A0196);
                }
                List A01103 = C59695JUc.A01(str29);
                List A0026 = C59705JUn.A00(query.getString(A0197));
                JYL jyl = (JYL) C51968G9o.A10(JYL.A01, query.getInt(A0198));
                if (jyl == null) {
                    jyl = JYL.VIDEO;
                }
                r86 = new AnonymousClass9OY(r87, A0021, A0017, A0020, mediaGenAIDetectionMethod, A0014, A008, A007, A0016, A009, r97, A002, r99, A0019, lms, new C377999Ob(jyl, A01103, A0026, i4), r2, r104, A0012, A005, A006, A0011, A0015, string4, str, str5, string5, str9, str10, str12, str13, str15, str18, str19, str20, str23, str24, str25, A003, A004, A0010, A0199, A01100, A0013, A01101, A01102, A0018, i, j, j2, j3, j4, A1P, A1P2, A1P3, A1P4, A1P5, A1P6, A1P7, A1P8, A1P9, A1P10, A1P11, A1P12, A1P13);
            } else {
                r86 = null;
            }
            r157.setTransactionSuccessful();
            query.close();
            r156.A00();
            r157.endTransaction();
            return r86;
