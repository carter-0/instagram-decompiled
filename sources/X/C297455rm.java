...
public final class C297455rm extends C263934Nx {
    public final void A00(C58840Ae r13) {
        ...
        0qQ.A0B(r13, 0);
        0wc r132 = (0wc) r13;
        0Aj A00 = r132.A00(r132.A00, "video_exited");
        if (A00.isSampled()) {
            ...
            if (r3 != null) {
                ...
                if (num != null) {
                    ...
                    boolean A0K = 0qQ.A0K(r3.A05, true);
                    A00.A9F("seq_num", Long.valueOf((long) intValue));
                    A00.AAJ("m_pk", str6);
                    A00.AAE(r9, "a_pk");
                    A00.AAJ("a_i", str7);
                    A00.A9F("loop_count", Long.valueOf(i.longValue()));
                    A00.A8D("lsp", Double.valueOf(i2.doubleValue()));
                    Float f = r3.A0I;
                    if (f != null) {
                    ...
                    A00.A8D("time", d2);
                    A00.A9F("playing_audio", Long.valueOf(A0K ? 1 : 0));
                    Float f3 = r3.A0G;
                    if (f3 != null) {
                    ...
                    A00.A9F("is_dash_eligible", l19);
                    A00.AAJ("inventory_source", r3.A0y);
                    A00.AAJ("playback_format", r3.A16);
                    A00.AAJ("video_codec", r3.A1K);
                    A00.A7p("is_replay", (Boolean) null);
                    A00.AAJ(ThreadMetadataOverrideFragment.BUNDLE_THREAD_ID, (String) null);
                    ...
                    A00.AAJ("is_network_roaming", str2);
                    ...
                    A00.AAJ("network_generation", str3);
                    ...
                    A00.AAJ("network_type_info", str5);
            ...
            if (r5 != null) {
                if (z) {
                    Integer num8 = r5.A0K;
                    if (num8 != null) {
                        l3 = Long.valueOf((long) num8.intValue());
                    } else {
                        l3 = null;
                    }
                    ...
                    Integer num9 = r5.A0L;
                    if (num9 != null) {
                        l4 = Long.valueOf((long) num9.intValue());
                    } else {
                        l4 = null;
                    }
                    ...
                    Integer num10 = r5.A0A;
                    if (num10 != null) {
                        l5 = Long.valueOf((long) num10.intValue());
                    } else {
                        l5 = null;
                    }
                    A00.A9F("session_reel_counter", l5);
                    A00.AAJ("tray_session_id", r5.A0a);
                    Integer num11 = r5.A0N;
                    if (num11 != null) {
                    ...
                    A00.A7p("video_subtitles_available", r5.A04);
                    A00.A7p("video_subtitles_displayed", r5.A05);
                }
                0bb r6 = new 0bb();
                ...
                if ((r0 == null || r0.A16 == null) && z) {
                    A00.AAJ("playback_format", r5.A0U);
                    Integer num22 = r5.A0B;
                    if (num22 != null) {
                        l23 = Long.valueOf((long) num22.intValue());
                    }
                    A00.A9F("is_dash_eligible", l23);
                }
            }
