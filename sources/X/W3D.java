...
public final class W3D {
    ...
    public static final double A02(double[] dArr, double[] dArr2) {
        char A1U = AnonymousClass7TF.A1U(0, dArr, dArr2);
        return (dArr[0] * dArr2[0]) + (dArr[A1U] * dArr2[A1U]) + (dArr[2] * dArr2[2]);
    }
    ...
    public static final void A04(double[] dArr, double[] dArr2, double[] dArr3) {
        double[] dArr4 = dArr;
        double[] dArr5 = dArr2;
        char A1U = AnonymousClass7TF.A1U(0, dArr4, dArr5);
        0qQ.A0B(dArr3, 2);
        double d = dArr5[0];
        double d2 = dArr5[A1U];
        double d3 = dArr5[2];
        ...
        double d16 = dArr5[15];
        double d17 = dArr3[0];
        double d18 = dArr3[A1U];
        double d19 = dArr3[2];
        double d20 = dArr3[3];
        dArr4[0] = (d17 * d) + (d18 * d5) + (d19 * d9) + (d20 * d13);
        dArr4[A1U] = (d17 * d2) + (d18 * d6) + (d19 * d10) + (d20 * d14);
    ...
    public static final double[] A07(double[] dArr, double[] dArr2, double d) {
        ...
        dArr3[A1U] = (dArr[A1U] * 1.0d) + (dArr2[A1U] * d);
