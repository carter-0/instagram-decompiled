...
public final class C68919Naw extends PC9 {
    ...
    public C68919Naw(Context context, UserSession userSession, AnonymousClass9HO r11, AnonymousClass9HC r12, AnonymousClass7L2 r13) {
    ...
    public final boolean AFT(C74541Pwa pwa, C74552Pwl pwl, int i) {
        ...
        Integer BmO = pwl.BmO(i);
        if (BmO == null || BmO.intValue() != 3) {
            return true;
        }
        return false;
    }
