...
public final class C59460Ul extends AnonymousClass0Bt {
    public volatile AnonymousClass0C5 A00;

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: null in method: X.0Ul.A04(X.0Bs):boolean, dex: classes.dex
    ...
    public final /* bridge */ /* synthetic */ boolean A04(X.0Bs r1) {
        /*
        // Can't load method instructions: Load method exception: null in method: X.0Ul.A04(X.0Bs):boolean, dex: classes.dex
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C59460Ul.A04(X.0Bs):boolean");
    }
