...
public final class AnonymousClass7CJ implements C327687Bu {
    ...
    public final boolean AFS(UserSession userSession, C254703su r5, int i) {
        ...
        if (i != 29 || !182.A06(0Tu.A05, userSession, 36319342967200911L)) {
            return false;
        }
        return true;
    }
    ...
    public final boolean AFq(UserSession userSession, C254703su r5) {
        0qQ.A0B(userSession, 0);
        return 182.A06(0Tu.A05, userSession, 36319342967331985L);
    }
