...
public abstract class HYH {
    public static final void A00(C62320sa r6, C286575Wy r7, int i) {
        ...
        if ((i2 & 11) != 2 || !r7.Bwn()) {
            if (0fL.A02()) {
                0fL.A01(-1632653269, "com.instagram.creation.genai.magicmod.common.ui.MagicModRetryFooterButton (MagicModRetryButton.kt:20)");
            }
            Alignment alignment = C287215Zl.A09;
            Modifier A0F = C51975G9x.A0F(r7, Modifier.A00);
            boolean A1N = C51973G9u.A1N(r7, 356504384, i2);
            Object ECw = r7.ECw();
            if (A1N || ECw == AnonymousClass5XT.A00) {
                ECw = C58678Ivn.A00(r7, r6, 21);
            }
            C286565Wx r4 = (C286565Wx) r7;
            Modifier A0F2 = G9w.A0F(C51967G9n.A0G(G9w.A0D(r7, r4, A0F, (C62320sa) ECw), 24.0f));
            ...
            AnonymousClass5ZZ.A0t(r7, C51966G9m.A0h(r7), C304346Dc.A00(r7, 2131972371), G9w.A05(r7));
            if (C51967G9n.A1R(r7)) {
                0fL.A00(-1307332227);
            }
        } else {
