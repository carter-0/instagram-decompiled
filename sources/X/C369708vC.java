...
public final class C369708vC extends Drawable implements C268714ds {
    ...
    public C369708vC(Context context, Integer num, int i, long j) {
        this.A00 = num;
        ...
        paint.setTypeface(AnonymousClass0qo.A00(context).A02(0qm.A0V));
        this.A0G = paint;
        Rect rect = new Rect();
        ...
        int A012 = C61380mr.A01(context, 8);
        this.A04 = A012;
        this.A01 = (float) resources.getDimensionPixelSize(R.dimen.abc_button_inset_vertical_material);
        Bitmap A002 = AnonymousClass6MX.A00(resources, R.drawable.instagram_clock_dotted_pano_outline_24);
        this.A0B = A002;
        ...
        this.A09 = Math.min(i, rect.width() + i2 + A002.getWidth() + A012);
        this.A03 = rect.height() + i2;
        int[] A0x = 00k.A0x(0sr.A1P(new Integer[]{Integer.valueOf(context.getColor(R.color.green_5)), Integer.valueOf(context.getColor(R.color.cyan_5))}));
        this.A0L = A0x;
        this.A07 = context.getColor(2Yu.A08(context));
        this.A08 = context.getColor(R.color.igds_gradient_cyan);
        this.A06 = context.getColor(2Yu.A0H(context, R.attr.igds_color_icon_badge));
        Shader.TileMode tileMode = Shader.TileMode.REPEAT;
        this.A0F = new LinearGradient((float) (getBounds().centerX() - (rect.width() / 2)), 0.0f, (float) rect.width(), 0.0f, A0x, (float[]) null, tileMode);
        this.A0E = new LinearGradient(0.0f, 0.0f, (float) A002.getWidth(), 0.0f, A0x, (float[]) null, tileMode);
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        rectF.inset((float) ((-this.A09) / 2), (float) ((-this.A03) / 2));
        float f = this.A01;
        ...
        canvas.drawText(str, f2 + f3 + ((float) bitmap.getWidth()) + ((float) this.A04), (float) (getBounds().centerY() + (min / 2)), paint);
        ...
        canvas.drawBitmap(bitmap2, f4, (float) (getBounds().centerY() - (bitmap.getHeight() / 2)), paint);
    }
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [X.50v, java.lang.Object] */
