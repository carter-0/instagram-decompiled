...
public abstract class AnonymousClass3JT {
    ...
    public static final BitmapDrawable A03(Context context, Drawable drawable, int i, int i2) {
        ...
        return A00(context, new LinearGradient(0.0f, 0.0f, 0.0f, (float) height, i2, i, Shader.TileMode.REPEAT), drawable);
    }
    ...
    public static final StateListDrawable A08(Context context, int i, int i2, int i3, int i4) {
        return A09(context, new int[]{i3, i}, new int[]{i4, i2}, new int[][]{new int[]{16842919}, new int[0]});
    }
    ...
    public static final BitmapDrawable A02(Context context, Drawable drawable, int i, int i2) {
        ...
        return A00(context, new LinearGradient(0.0f, (float) height, (float) width, 0.0f, i, i2, Shader.TileMode.REPEAT), drawable);
    }
    ...
    public static final BitmapDrawable A04(Context context, int[] iArr, int i) {
        ...
        if (drawable != null) {
            ...
            return A00(context, new LinearGradient(0.0f, (float) height, (float) width, 0.0f, iArr, (float[]) null, Shader.TileMode.REPEAT), drawable);
        }
        throw new IllegalStateException("Required value was null.");
    }
    ...
    public static final StateListDrawable A07(Context context, int i) {
        0qQ.A0B(context, 0);
        return A09(context, new int[]{R.drawable.instagram_circle_check_pano_filled_24, R.drawable.checkbox}, new int[]{i, -1}, new int[][]{new int[]{16842912}, new int[0]});
    }
}
