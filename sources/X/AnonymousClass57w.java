...
public final class AnonymousClass57w implements AnonymousClass0TL {
    public String A00;
    public String A01;
    public boolean A02;
    public boolean A03;
    ...
    public final Collection getDataPoints() {
        ...
        if (nativeGetNativeRenderThreadStats != null) {
            try {
                bufferedReader = new BufferedReader(new StringReader(nativeGetNativeRenderThreadStats));
                ...
                while (true) {
                    ...
                    if (str == null) {
                        ...
                        while (readLine != null && readLine.startsWith(" ")) {
                            ...
                            if (matcher.find()) {
                                if (this.A00.contains("Glyph Cache:")) {
                                    arrayList.add(new 0TD(0TJ.A0C, A00(matcher)));
                                    this.A03 = true;
                                    z2 = true;
                                } else {
                                    j += A00(matcher);
                        ...
                        if (j > 0 || this.A09) {
                            arrayList.add(new 0TD(0TJ.A0D, j));
                            this.A09 = true;
                        }
                        if (this.A03 && !z2) {
                            arrayList.add(new 0TD(0TJ.A0C, 0));
                        }
                        ...
                        if (j2 > 0 || this.A0A) {
                            arrayList.add(new 0TD(0TJ.A0L, j2));
                            this.A0A = true;
                        }
                        if (j3 > 0 || this.A05) {
                            arrayList.add(new 0TD(0TJ.A0K, j3));
                            this.A05 = true;
                        }
                        if (j4 > 0 || this.A04) {
                            arrayList.add(new 0TD(0TJ.A0J, j4));
                            this.A04 = true;
                        }
                        if (j5 > 0 || this.A0B) {
                            arrayList.add(new 0TD(0TJ.A0M, j5));
                            this.A0B = true;
                        }
                        ...
                        if (j6 > 0 || this.A0C) {
                            arrayList.add(new 0TD(0TJ.A0E, j6));
                            this.A0C = true;
                        }
                        if (j7 > 0 || this.A02) {
                            arrayList.add(new 0TD(0TJ.A0F, j6));
                            this.A02 = true;
                        }
                        ...
                        if (j8 > 0 || this.A0D) {
                            arrayList.add(new 0TD(0TJ.A0O, j8));
                            this.A0D = true;
                        }
                        if (j9 > 0 || this.A06) {
                            arrayList.add(new 0TD(0TJ.A0N, j9));
                            this.A06 = true;
                        }
                    } else {
                        if (str.equals("Layer Info:")) {
                                ...
                                if (readLine5 != null && readLine5.startsWith(" ")) {
                                    if (!z3) {
                                        ...
                                        if (matcher5.find()) {
                                            ...
                                            if (matcher6.find() && matcher6.groupCount() >= 1 && (group2 = matcher6.group(1)) != null) {
                                                try {
                            ...
                            if (j10 > 0 || this.A08) {
                                arrayList.add(new 0TD(0TJ.A0Y, j10));
                                this.A08 = true;
                            }
                            if (i > 0 || this.A07) {
                                r0 = new 0TD(0TJ.A0Z, (long) i);
                            }
                                ...
                                if (readLine6 != null && readLine6.startsWith(" ")) {
                                    if (!z4 && readLine6.startsWith("  Layers Total")) {
                                        ...
                                        if (matcher7.find()) {
                                            ...
                                            if (matcher8.find() && matcher8.groupCount() >= 1 && (group = matcher8.group(1)) != null) {
                                                try {
                            ...
                            if (j11 > 0 || this.A08) {
                                arrayList.add(new 0TD(0TJ.A0Y, j11));
                                this.A08 = true;
                            }
                            if (i2 > 0 || this.A07) {
                                r0 = new 0TD(0TJ.A0Z, (long) i2);
                            }
                            ...
                            while (readLine7 != null && readLine7.startsWith(" ")) {
                                if (!z5) {
                                    ...
                                    if (matcher9.find()) {
                                        arrayList.add(new 0TD(0TJ.A0C, A00(matcher9)));
                                        z5 = true;
                                    }
                                }
    ...
    public static long A00(java.util.regex.Matcher r7) {
        ...
        L_0x0045:
            ...
            goto L_0x0034
        L_0x0048:
            double r3 = java.lang.Double.parseDouble(r0)     // Catch:{ NumberFormatException -> 0x004c }
        L_0x004c:
            double r3 = r3 * r1
        ...
        L_0x0052:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass57w.A00(java.util.regex.Matcher):long");
    }

    public AnonymousClass57w() {
        this(false);
    }
}
