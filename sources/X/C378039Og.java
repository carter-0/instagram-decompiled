...
public final class C378039Og implements View.OnTouchListener {
    ...
    public final boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L_0x002f:
            ...
            goto L_0x001d
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C378039Og.onTouch(android.view.View, android.view.MotionEvent):boolean");
    }

    public C378039Og(View view, Runnable runnable, boolean z, boolean z2, boolean z3) {
        int i;
        int i2;
        this.A02 = view;
        this.A03 = runnable;
