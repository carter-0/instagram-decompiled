...
public final class C276754tq implements C276744tp {
            ...
            if (!(obj instanceof String)) {
                if (obj instanceof JSONObject) {
                    ...
                    if (obj instanceof Double) {
                        obj = Q0A.A00(((Number) obj).doubleValue());
                    } else if (obj instanceof Float) {
                        obj = Q0A.A00((double) ((Number) obj).floatValue());
    ...
    public final Object ASw(C307896Rx r6, AnonymousClass6Tm r7, String str) {
        char c = 65535;
        switch (str.hashCode()) {
            case -863899808:
        ...
        switch (c) {
            case 0:
                try {
                    return A02(new JSONObject((String) r7.A03(0)));
                } catch (JSONException e) {
                    throw new IllegalArgumentException("Trying to decode malformed json", e);
                }
            case 1:
                return A00(r7.A00.get(0), false, true);
            case 2:
                List list = r7.A00;
                return A00(list.get(0), Q0A.A01(list.get(1)), true);
            case 3:
                List list2 = r7.A00;
                return A00(list2.get(0), Q0A.A01(list2.get(1)), false);
            case 4:
                try {
                    return A01(new JSONArray((String) r7.A03(0)));
                } catch (JSONException e2) {
                    throw new IllegalArgumentException("Trying to decode malformed json", e2);
                }
            default:
                throw new RuntimeException(002.A0R("Unknown lispy action type: ", str));
        }
    }
}
