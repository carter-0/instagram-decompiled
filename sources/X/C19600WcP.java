...
public final class C19600WcP implements X70 {
    ...
    public final void DEL(C18043VkR vkR, Product product, Throwable th, long j, long j2) {
        ...
        uql.A04(vkR, product, str, j, j2, false);
        u8r.A00.remove(vkR.A01());
        C14781U8r.A00(u8r, new C20785Wyw(vkR, 17));
    ...
    public final void Dor(AnonymousClass1XT r13, C18043VkR vkR, Product product, long j, long j2) {
        C14781U8r u8r = this.A00;
        u8r.A02.A04(vkR, product, (String) null, j, j2, true);
        u8r.A00.remove(vkR.A01());
        C14781U8r.A00(u8r, new C20785Wyw(vkR, 18));
    }

    public C19600WcP(C14781U8r u8r) {
        this.A00 = u8r;
    }
}
