...
public abstract class RUX {
    /* JADX WARNING: type inference failed for: r9v2, types: [java.lang.Object, X.RyQ] */
    /* JADX WARNING: type inference failed for: r10v0, types: [X.Rz7, java.lang.Object] */
    public static final C10804RyQ A00(Bundle bundle) {
        ...
        while (A1G.hasNext()) {
            BaseBundle baseBundle = (BaseBundle) AnonymousClass7TF.A0a(A1G);
            ? obj = new Object();
            0qQ.A0B(baseBundle, 0);
