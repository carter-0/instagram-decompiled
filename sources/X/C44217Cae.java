...
public abstract class C44217Cae {
    public static JV7 parseFromJson(16F r10) {
        ...
        try {
            ...
            if (simpleImageUrl == null && (r10 instanceof 0c9)) {
                AnonymousClass7TF.A1L("cover_artwork_uri", r10, "MoodsData");
            } else if (str == null && (r10 instanceof 0c9)) {
                AnonymousClass7TF.A1L(PublicKeyCredentialControllerUtility.JSON_KEY_ID, r10, "MoodsData");
            } else if (str2 != null || !(r10 instanceof 0c9)) {
                return new JV7((ImageUrl) simpleImageUrl, str, str2, 5);
            } else {
                AnonymousClass7TF.A1L(PublicKeyCredentialControllerUtility.JSON_KEY_NAME, r10, "MoodsData");
            }
