...
public final class C39649A3p {
    public final Matrix4 A00;

    public C39649A3p(float f, float f2, float f3, int i, int i2) {
        float f4;
        float f5;
        float f6 = (((float) i) * f2) / (((float) i2) * f3);
        ...
        throw AnonymousClass7TE.A0w("Only rotation angles multiple of 90 deg are supported");
    }
}
