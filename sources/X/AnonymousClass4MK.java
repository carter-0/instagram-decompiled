...
public final class AnonymousClass4MK {
    public int A00;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x001f, code lost:
        if (X.182.A06(X.0Tu.A05, r4, 36312110243447717L) == false) goto L_0x0021;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public AnonymousClass4MK(com.instagram.common.session.UserSession r4, java.lang.ref.WeakReference r5) {
        /*
            r3 = this;
            r0 = 2
            r3.<init>()
        ...
        L_0x0022:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass4MK.<init>(com.instagram.common.session.UserSession, java.lang.ref.WeakReference):void");
    }
    ...
    public final void A00(ViewGroup viewGroup, String str) {
        ...
        if (this.A04) {
            ...
            if (!(weakReference2 == null || (textView3 = (TextView) weakReference2.get()) == null)) {
                ...
                if (!0qQ.A0K(textView3.getParent(), viewGroup)) {
            ...
            if (!(weakReference3 == null || (textView2 = (TextView) weakReference3.get()) == null)) {
                ...
                if (!0qQ.A0K(textView2.getParent(), viewGroup)) {
            ...
            if (weakReference4 != null && (textView = (TextView) weakReference4.get()) != null) {
                ...
                if (!0qQ.A0K(textView.getParent(), viewGroup)) {
