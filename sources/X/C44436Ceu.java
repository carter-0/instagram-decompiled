...
public abstract /* synthetic */ class C44436Ceu {
    public static Map A00(C283415Ho r4) {
        ...
        String str = null;
        if (r4.Bjq() != null) {
            AnonymousClass6LH Bjq = r4.Bjq();
            if (Bjq != null) {
                treeUpdaterJNI2 = Bjq.FHC();
            } else {
                treeUpdaterJNI2 = null;
            }
            A1H.put(AnonymousClass000.A00(5167), treeUpdaterJNI2);
        }
        if (r4.Bof() != null) {
