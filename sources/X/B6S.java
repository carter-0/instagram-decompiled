...
public abstract /* synthetic */ class B6S {
    public static Map A00(C283425Hp r4) {
        ...
        String str = null;
        if (r4.C0g() != null) {
            StoryLinkInfoDictIntf C0g = r4.C0g();
            if (C0g != null) {
                treeUpdaterJNI2 = C0g.FHC();
            } else {
                treeUpdaterJNI2 = null;
            }
            A1H.put("story_link", treeUpdaterJNI2);
        }
        if (r4.C2V() != null) {
