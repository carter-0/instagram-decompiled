...
public abstract /* synthetic */ class C9918RjX {
    ...
    static {
        /*
            X.RDR[] r0 = X.RDR.values()
            int r0 = r0.length
            int[] r1 = new int[r0]
            X.RDR r0 = X.RDR.A02     // Catch:{ NoSuchFieldError -> 0x000c }
            X.C66581MXm.A1N(r0, r1)     // Catch:{ NoSuchFieldError -> 0x000c }
        L_0x000c:
            X.RDR r0 = X.RDR.A03     // Catch:{ NoSuchFieldError -> 0x0011 }
            X.C51970G9q.A1M(r0, r1)     // Catch:{ NoSuchFieldError -> 0x0011 }
        L_0x0011:
            X.RDR r0 = X.RDR.A04     // Catch:{ NoSuchFieldError -> 0x0016 }
            X.C66581MXm.A1O(r0, r1)     // Catch:{ NoSuchFieldError -> 0x0016 }
        L_0x0016:
            A00 = r1
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C9918RjX.<clinit>():void");
    }
}
