...
public final class S52 {
    ...
    public S52(int i, int i2) {
        ...
        this.A05 = new short[]{0, 1, 2, 0, 2, 3};
        ...
        int A002 = C7242Q0o.A00(35633, "uniform mat4 uMVPMatrix;attribute vec4 vPosition;attribute vec2 a_texCoord;varying vec2 v_texCoord;void main() {  gl_Position = uMVPMatrix * vPosition;  v_texCoord = a_texCoord;}");
        int A003 = C7242Q0o.A00(35632, "precision mediump float;varying vec2 v_texCoord;uniform sampler2D s_texture;void main() {  gl_FragColor = texture2D( s_texture, v_texCoord );}");
        int glCreateProgram = GLES20.glCreateProgram();
        this.A06 = glCreateProgram;
        GLES20.glAttachShader(glCreateProgram, A002);
        GLES20.glAttachShader(this.A06, A003);
    ...
    public final void A01() {
        ...
        GLES20.glVertexAttribPointer(glGetAttribLocation, 3, 5126, false, 0, this.A01);
        int glGetAttribLocation2 = GLES20.glGetAttribLocation(this.A06, "a_texCoord");
        GLES20.glEnableVertexAttribArray(glGetAttribLocation2);
        GLES20.glVertexAttribPointer(glGetAttribLocation2, 2, 5126, false, 0, this.A00);
