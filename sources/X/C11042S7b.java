...
/* renamed from: X.S7b  reason: case insensitive filesystem */
public final class C11042S7b {
    public List A00;
    public int[] A01;
    ...
    public final void A04(int i) {
        ...
        if (iArr2 != null && i < iArr2.length) {
            if (this.A00 != null) {
                StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem A002 = A00(i);
                if (A002 != null) {
                ...
                while (true) {
                    if (i2 >= size) {
                        break;
                    } else if (((StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem) this.A00.get(i2)).A01 < i) {
                        i2++;
                    } else if (i2 != -1) {
                        this.A00.remove(i2);
                        int i3 = ((StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem) this.A00.get(i2)).A01;
                        if (i3 != -1) {
                            iArr = this.A01;
