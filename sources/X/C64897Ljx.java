...
public final class C64897Ljx implements AnonymousClass33B {
    public final Activity A00;
    public final UserSession A01;
    public final LCf A02;
    ...
    public final void DVf(View view, NoteCustomTheme noteCustomTheme, ContentNoteMetadata contentNoteMetadata, AnonymousClass4DU r11, Integer num, Integer num2, Long l, String str, boolean z, boolean z2) {
        String str2 = contentNoteMetadata.A09;
        if (str2 != null) {
            GPJ.A00.A04(GPK.REPLY_SHEET, this.A01, contentNoteMetadata.A04, contentNoteMetadata.A06, contentNoteMetadata.A0A, str2);
        }
        this.A02.A00(this.A00);
    }

    public C64897Ljx(Activity activity, UserSession userSession, LCf lCf) {
        AnonymousClass7TG.A1P(userSession, lCf);
