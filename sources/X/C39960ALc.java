...
public final class C39960ALc implements InputFilter {
    ...
    public final java.lang.CharSequence filter(java.lang.CharSequence r23, int r24, int r25, android.text.Spanned r26, int r27, int r28) {
        ...
        L_0x0016:
            r7 = r27
            r6 = r28
            java.lang.StringBuilder r0 = X.00l.A0N(r8, r0, r7, r6)
            ...
            r17 = r14
            r18 = r0
            float r0 = X.AIJ.A00(r15, r16, r17, r18, r19, r20, r21)
        ...
        L_0x00b2:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C39960ALc.filter(java.lang.CharSequence, int, int, android.text.Spanned, int, int):java.lang.CharSequence");
    }

    public C39960ALc(View view, TextView textView, IgSimpleImageView igSimpleImageView) {
        AnonymousClass7TG.A1Q(igSimpleImageView, view);
        this.A06 = textView;
