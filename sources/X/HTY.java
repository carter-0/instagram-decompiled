...
public abstract class HTY {
    public static ContextualAdResponseExtrasImpl parseFromJson(16F r7) {
        0qQ.A0B(r7, 0);
        try {
            if (r7.A11() != 16L.A0D) {
                r7.A0z();
            ...
            return new ContextualAdResponseExtrasImpl(str, str2, str3, str4);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
