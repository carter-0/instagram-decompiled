...
public abstract /* synthetic */ class CkK {
    public static Map A00(C282545Dm r4) {
        ...
        String str = null;
        if (r4.BAH() != null) {
            AnonymousClass5FT BAH = r4.BAH();
            if (BAH != null) {
                treeUpdaterJNI3 = BAH.FHC();
            } else {
                treeUpdaterJNI3 = null;
            }
            A1H.put(C273654mx.A00(2420), treeUpdaterJNI3);
        }
        if (r4.BCt() != null) {
        ...
        if (r4.BNh() != null) {
            LocationDictIntf BNh = r4.BNh();
            if (BNh != null) {
                treeUpdaterJNI2 = BNh.FHC();
            } else {
                treeUpdaterJNI2 = null;
            }
            A1H.put("location", treeUpdaterJNI2);
        }
