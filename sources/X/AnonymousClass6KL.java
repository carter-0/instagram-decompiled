...
public final class AnonymousClass6KL extends Drawable {
    public float A00;
    public int A01;
    public int A02;
    public int A03;
    ...
    public AnonymousClass6KL(int i, int i2, int i3, int i4, boolean z) {
        ...
        paint3.setColor(-1);
        paint2.setColor(-1);
        rectF.set(0.0f, 0.0f, f, (float) i4);
        rectF2.set(0.0f, 0.0f, f, (float) i3);
    }
}
