...
public abstract class C345907uH {
    public static String A00(String str, String str2, int i) {
        return String.format((Locale) null, "%s: GL error 0x%04x %s occurred, see logcat output", new Object[]{str, Integer.valueOf(i), str2});
    }
    ...
    public static void A02(String str, Object... objArr) {
        ...
        if (z) {
            ...
            switch (i) {
                case 1280:
                    throw new C345117sx(1280, A00(format, "GL_INVALID_ENUM", i));
                case 1281:
                    throw new C345117sx(1281, A00(format, "GL_INVALID_VALUE", i));
                case 1282:
                    throw new C345117sx(1282, A00(format, "GL_INVALID_OPERATION", i));
                case 1285:
                    throw new C345117sx(1285, A00(format, "GL_OUT_OF_MEMORY", i));
                case 1286:
                    throw new C345117sx(1286, A00(format, "GL_INVALID_FRAMEBUFFER_OPERATION", i));
                default:
                    throw new C345117sx(i, A00(format, "UNKNOWN", i));
            }
        }
    }
