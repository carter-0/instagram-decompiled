...
public abstract class C44320Cd2 {
    public static BGG parseFromJson(16F r5) {
        0qQ.A0B(r5, 0);
        try {
            Boolean bool = null;
            if (r5.A11() != 16L.A0D) {
            ...
            while (r5.A1J() != 16L.A09) {
                ...
                if ("ads_toggled_on".equals(A17)) {
                    ...
                    bool2 = C41847B3o.A0z(r5, bool2, A17, "is_media_eligible_for_inserting_ads");
                }
                r5.A0z();
            }
            return new BGG(bool, bool2, num);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
