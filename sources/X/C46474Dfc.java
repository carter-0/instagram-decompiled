...
public final class C46474Dfc {
    ...
    public final UserDetailLaunchConfig A04() {
        ...
        IgxfbNetEgoCTABannerParams igxfbNetEgoCTABannerParams = this.A01;
        return new UserDetailLaunchConfig((FilterConfig) null, userPayFanclubUpsellParams, igxfbNetEgoCTABannerParams, autoLaunchReelParams, userDetailEntryInfo, sourceModelInfoParams, this.A05, l, l2, str, str2, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12, str13, str14, str15, str16, str17, str18, str19, str20, str21, str22, str23, (ArrayList) null, z, z2, z3, z4, z5, z6, z7, false, z8, z9, z10, z11, z12, z13, z14, z15, z16, z17, z18, this.A0Z);
    }

    public C46474Dfc(String str, String str2, String str3) {
        this.A0n = str;
        this.A0B = str2;
        this.A0m = str3;
    }

    public static Fragment A00(UserSession userSession, 1a1 r2, C46474Dfc dfc) {
        return r2.A02(userSession, dfc.A04());
    }

    public static UserDetailLaunchConfig A01(UserSession userSession, String str, String str2, String str3) {
        return C46548Dgp.A01(userSession, str, str2, str3).A04();
    }

    public static void A02(C309516Yo r1, UserSession userSession, 1a1 r3, C46474Dfc dfc) {
        r1.A0E(r3.A02(userSession, dfc.A04()));
        r1.A04();
    }

    public static void A03(C309516Yo r1, UserSession userSession, 1a1 r3, C46474Dfc dfc) {
        r1.A0D(r3.A02(userSession, dfc.A04()));
        r1.A04();
    }
}
