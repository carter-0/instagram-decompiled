...
public abstract class C39902AIk {
    ...
    public static int A00(int i) {
        ...
        if (!(i == 1 || i == 2)) {
            if (i != 3) {
                ...
                if (i != 4) {
                    if (i != 13) {
                        throw AnonymousClass7TE.A0w(002.A0O(AnonymousClass000.A00(2111), i));
                    }
                }
            }
            return i2;
    ...
    public static long A01(int i, int i2, long j, long j2) {
        return (((j / ((long) A00(i))) / ((long) i2)) * 1000000) / j2;
    }
}
