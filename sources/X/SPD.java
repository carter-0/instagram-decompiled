...
public final class SPD {
    ...
    public final GoogleSignInAccount A01() {
        ...
        if (!TextUtils.isEmpty(A033) && (A032 = A03(002.A0g("googleSignInAccount", ":", A033))) != null) {
            try {
                String str6 = null;
                if (!TextUtils.isEmpty(A032)) {
                    JSONObject A17 = C66580MXl.A17(A032);
                    ...
                    long A09 = Pxi.A09("expirationTime", A17);
                    HashSet A1F = AnonymousClass7TE.A1F();
                    JSONArray jSONArray = A17.getJSONArray("grantedScopes");
                    int length = jSONArray.length();
                    for (int i = 0; i < length; i++) {
                        A1F.add(new Scope(1, jSONArray.getString(i)));
                    }
                    ...
                    AnonymousClass3Qk.A04(string);
                    GoogleSignInAccount googleSignInAccount = new GoogleSignInAccount(uri, optString2, str, str2, str3, (String) null, string, str4, str5, AnonymousClass7TE.A1D(A1F), 3, A09);
    ...
    public final GoogleSignInOptions A02() {
        ...
        String str2;
        String A033 = A03("defaultGoogleSignInAccount");
        if (!TextUtils.isEmpty(A033) && (A032 = A03(002.A0g("googleSignInOptions", ":", A033))) != null) {
            try {
                ...
                if (!TextUtils.isEmpty(A032)) {
                    ...
                    ArrayList A1D = AnonymousClass7TE.A1D(A1F);
                    ...
                    return new GoogleSignInOptions(account, str2, str3, (String) null, A1D, AnonymousClass7TE.A1E(), 3, z, z2, z3);
                }
            } catch (JSONException unused) {
            }
        }
    ...
    public final void A04(String str, String str2) {
        ...
        lock.lock();
        try {
            Pxf.A13(this.A00.edit(), str, str2);
        } finally {
            lock.unlock();
        }
    }
    ...
    public SPD(Context context) {
        this.A00 = Pxe.A0H(context, "com.google.android.gms.signin");
    }

    public static SPD A00(Context context) {
        ...
        try {
            SPD spd = A02;
            if (spd == null) {
                spd = new SPD(context.getApplicationContext());
                A02 = spd;
            }
            return spd;
        } finally {
