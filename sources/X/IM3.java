...
public final class IM3 implements C270754hF {
    public final String A00;

    public final 1OC BCc(UserSession userSession, boolean z) {
        0qQ.A0B(userSession, 0);
        String str = this.A00;
        boolean A06 = 182.A06(0Tu.A05, userSession, 36328229254020191L);
        1NY A0a = AnonymousClass7TG.A0a(userSession);
        A0a.A0A("clips/associated_clips/");
        G9w.A1I(A0a, "original_media_id", str, (String) null);
        A0a.A0H("should_show_friends_media_at_top", A06);
        return DbU.A0S(A0a, C43877CGr.class, C45658D0i.class);
    }
    ...
    public final 1OC C42(UserSession userSession, String str) {
        ...
        1NY A0a = AnonymousClass7TG.A0a(userSession);
        A0a.A0A("clips/associated_clips/");
        G9w.A1I(A0a, "original_media_id", str2, str);
