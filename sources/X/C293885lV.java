...
public final class C293885lV implements C228232l0 {
    ...
    public final Map AUH(String str) {
        ...
        linkedHashMap.putAll(this.A01.ATx(C233162v9.SAVE_CLICK, str));
    ...
    public final /* bridge */ /* synthetic */ void DUE(C301165yf r3, C233162v9 r4, Object obj, Object obj2) {
        ...
        0qQ.A0B(r5, 1);
        0qQ.A0B(r6, 2);
        if (r4 == C233162v9.SAVE_CLICK) {
            AnonymousClass3KX r02 = AnonymousClass3KW.A00;
            if (AnonymousClass3KX.A00(r6) && r5.CcK()) {
    ...
    public C293885lV(C296325ps r1, C296295pp r2) {
        this.A00 = r2;
        this.A01 = r1;
    }
}
