...
public final class IML implements C270754hF {
    ...
    public final 1OC BCc(UserSession userSession, boolean z) {
        ...
        A0a.A0A("clips/breaking_creators_clips/");
        C51965G9l.A1S(A0a, str);
        C51968G9o.A1M(A0a, "referrer_media_id", str2, (String) null);
    ...
    public final 1OC C42(UserSession userSession, String str) {
        ...
        C51968G9o.A1M(A0a, "referrer_media_id", str3, str);
        C51972G9s.A18(A0a, userSession, AnonymousClass93W.class);
        return A0a.A0M();
    }
