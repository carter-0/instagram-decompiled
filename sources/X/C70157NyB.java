...
public abstract class C70157NyB {
    /* JADX WARNING: type inference failed for: r0v4, types: [X.OE6, java.lang.Object] */
    public static OE6 parseFromJson(16F r3) {
        0qQ.A0B(r3, 0);
        try {
            ? obj = new Object();
            if (r3.A11() != 16L.A0D) {
            ...
            while (r3.A1J() != 16L.A09) {
                ...
                } else if ("primary_button_url".equals(A17)) {
