...
public abstract class C70127Nxh {
    public static final Intent A00(Context context, Long l, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, boolean z, boolean z2, boolean z3) {
        ...
        if (l != null) {
            appendQueryParameter.appendQueryParameter("occamadillo_thread_id", C66581MXm.A0x(l));
        }
        ...
        Intent data = C66580MXl.A0A(context, DirectNotificationActionReceiver.class).setAction(str).setData(appendQueryParameter.build());
        0qQ.A07(data);
        return data;
    }
}
