...
public final /* synthetic */ class C20543WtO implements C255533uI {
    public static final C20543WtO A00;
    ...
    public final /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        ...
        while (true) {
            ...
            if (ANp == -1) {
                ...
                unrecoverableErrorCode = (UnrecoverableErrorCode) ADI.AO5(unrecoverableErrorCode, UnrecoverableErrorCodeSerializer.A00, serialDescriptor, 1);
                i |= 2;
            } else if (ANp == 2) {
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [X.WtO, java.lang.Object, X.3uI] */
    static {
        ? obj = new Object();
        A00 = obj;
        A01 = C13992Tns.A0U("com.shopify.checkout.models.errors.UnrecoverableErrorPayload", obj, 4);
    }

    public final C255463uA[] childSerializers() {
        C255453u9 r3 = C255453u9.A01;
        return new C255463uA[]{r3, UnrecoverableErrorCodeSerializer.A00, C360578eo.A00(r3), ErrorGroupSerializer.A00};
    }

    public final /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        UnrecoverableErrorPayload unrecoverableErrorPayload = (UnrecoverableErrorPayload) obj;
        boolean A1U = AnonymousClass7TF.A1U(0, encoder, unrecoverableErrorPayload);
        SerialDescriptor serialDescriptor = A01;
        AnonymousClass484 ADJ = encoder.ADJ(serialDescriptor);
        ADJ.ASC(unrecoverableErrorPayload.A02, serialDescriptor, 0);
        ADJ.AS8(unrecoverableErrorPayload.A01, UnrecoverableErrorCodeSerializer.A00, serialDescriptor, A1U ? 1 : 0);
        if (ADJ.EsA(serialDescriptor, 2) || unrecoverableErrorPayload.A03 != null) {
            ADJ.AS7(unrecoverableErrorPayload.A03, C255453u9.A01, serialDescriptor, 2);
        }
        ADJ.AS8(unrecoverableErrorPayload.A00, ErrorGroupSerializer.A00, serialDescriptor, 3);
