...
public final class IMD implements C270754hF {
    public final String A00;

    public final 1OC BCc(UserSession userSession, boolean z) {
        0qQ.A0B(userSession, 0);
        return DbT.A0T(I2R.A00(userSession, (String) null), "moment_id", this.A00);
    }

    public final 1OC C42(UserSession userSession, String str) {
        0qQ.A0B(userSession, 0);
        return DbT.A0T(I2R.A00(userSession, str), "moment_id", this.A00);
    }
