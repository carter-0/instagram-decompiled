...
public final class IWQ implements C21029XAi {
    ...
    public final void Cla(C324596za r6, boolean z) {
        ...
        A0b.A0K(C273654mx.A00(3471), new Object[]{str2});
    ...
    public final void Co2(1P0 r5, Integer num, String str, Set set) {
        ...
        if (intValue == 2) {
            ...
            r2 = this.A01;
            r0 = C56333Hwk.A01(this.A02, "feed_photos_of_you", set);
            r0.A00 = r5;
            r2.schedule(r0);
        } else if (intValue == 0) {
            r2 = this.A01;
        ...
        r0 = C56333Hwk.A00(userSession, str2, "feed_photos_of_you", set);
        r0.A00 = r5;
        r2.schedule(r0);
    }
    ...
    public IWQ(Context context, AnonymousClass07i r3, C228602lw r4, UserSession userSession) {
