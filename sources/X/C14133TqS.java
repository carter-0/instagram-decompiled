...
public final class C14133TqS<E> extends 04J<E> implements AnonymousClass62R<E> {
    public int A00;
    public int A01;
    public AnonymousClass6GA A02;
    public Object[] A03;
    public Object[] A04;
    public AnonymousClass62O A05;
    public Object[] A06 = null;
    public Object[] A07;

    /* JADX WARNING: type inference failed for: r0v1, types: [X.6GA, java.lang.Object] */
    public C14133TqS(AnonymousClass62O r4, Object[] objArr) {
        0qQ.A0B(objArr, 3);
        this.A05 = r4;
        this.A07 = objArr;
        this.A00 = 0;
    ...
    private final int A01(List list, List list2, 0sP r8, V3G v3g, Object[] objArr, int i, int i2) {
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [java.lang.Object, X.V3G] */
    ...
    /* JADX WARNING: type inference failed for: r8v0, types: [java.util.AbstractCollection, java.util.AbstractList, X.TqS] */
    ...
    /* JADX WARNING: type inference failed for: r14v0, types: [java.util.AbstractCollection, java.util.AbstractList, X.TqS] */
    /* JADX WARNING: type inference failed for: r4v0, types: [java.lang.Object, X.V3G] */
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x002d, code lost:
        if (r13 != false) goto L_0x002f;
     */
    ...
    public final boolean removeAll(java.util.Collection r23) {
        ...
        L_0x004b:
            ...
            java.lang.Object[] r9 = r14.A0H(r11)
            r8 = 1
            r2 = r10
        L_0x005f:
            int r10 = r10 + 1
        ...
        L_0x0077:
            ...
            r18 = r4
            r17 = r5
            int r2 = r14.A01(r15, r16, r17, r18, r19, r20, r21)
            goto L_0x0077
        L_0x0092:
            if (r8 == 0) goto L_0x005f
            int r0 = r2 + 1
        ...
        L_0x009a:
            ...
            r20 = r3
            r21 = r2
            int r5 = r14.A01(r15, r16, r17, r18, r19, r20, r21)
        ...
        L_0x00de:
            ...
            goto L_0x00de
        L_0x00f0:
            java.lang.Object[] r0 = r14.A0J(r3, r2, r1)
            goto L_0x00d2
        L_0x00f5:
            int r1 = r14.A00
            java.util.Iterator r0 = r16.iterator()
            java.lang.Object[] r3 = r14.A0E(r0, r3, r6, r1)
            goto L_0x00c1
        L_0x0100:
            int r4 = r14.A02(r5, r4, r3)
        ...
        L_0x0113:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C14133TqS.removeAll(java.util.Collection):boolean");
    }

    /* JADX WARNING: type inference failed for: r5v0, types: [java.lang.Object, X.V3G] */
    public final Object set(int i, Object obj) {
        ...
        0qQ.A0A(objArr);
        this.A03 = A0D(obj2, obj4, objArr, this.A00, i2);
        return obj4.A00;
    }

    /* JADX WARNING: type inference failed for: r7v0, types: [java.util.AbstractCollection, X.TqS] */
    private final int A02(0sP r8, V3G v3g, int i) {
    ...
    private final AnonymousClass6BX A04(int i) {
        if (this.A03 != null) {
            int A002 = A00() >> 5;
            AnonymousClass6BV.A01(i, A002);
            int i2 = this.A00;
            if (i2 == 0) {
                Object[] objArr = this.A03;
                0qQ.A0A(objArr);
                return new C20797Wz9(objArr, i);
            }
            int i3 = i2 / 5;
            Object[] objArr2 = this.A03;
            0qQ.A0A(objArr2);
            return new C14132TqR(objArr2, i, A002, i3);
        }
    ...
    private final void A07(Collection collection, Object[] objArr, Object[][] objArr2, int i, int i2, int i3) {
        ...
        if (this.A03 != null) {
            ...
            AnonymousClass6BX A042 = A04(A00() >> 5);
            while (true) {
                int previousIndex = A042.previousIndex();
                objArr3 = objArr2;
                objArr4 = (Object[]) A042.previous();
                if (previousIndex == i5) {
                    break;
                }
    ...
    private final Object[] A0C(Object obj, V3G v3g, Object[] objArr, int i, int i2) {
        Object obj2;
        int i3 = (i2 >> i) & 31;
        if (i == 0) {
            v3g.A00 = objArr[31];
        ...
        while (true) {
            A0H2[i3] = A0C(obj, v3g, objArr2, i4, i2);
            i3++;
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [java.util.AbstractList, X.TqS] */
    private final Object[] A0D(Object obj, V3G v3g, Object[] objArr, int i, int i2) {
        int i3 = (i2 >> i) & 31;
        Object[] A0H = A0H(objArr);
        if (i == 0) {
            if (A0H != objArr) {
        ...
        Object obj2 = A0H[i3];
        0qQ.A0C(obj2, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
        A0H[i3] = A0D(obj, v3g, (Object[]) obj2, i - 5, i2);
        return A0H;
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final java.lang.Object[] A0F(X.V3G r5, java.lang.Object[] r6, int r7, int r8) {
        /*
            r4 = this;
            int r0 = r8 + -1
            int r0 = r0 >> r7
        ...
        L_0x001d:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C14133TqS.A0F(X.V3G, java.lang.Object[], int, int):java.lang.Object[]");
    }

    private final Object[] A0G(V3G v3g, Object[] objArr, int i, int i2) {
        int i3 = (i2 >> i) & 31;
        int i4 = 31;
        if (i == 0) {
            Object obj = objArr[i3];
        ...
        if (i6 <= i4) {
            while (true) {
                Object obj2 = A0H2[i4];
                0qQ.A0C(obj2, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
                A0H2[i4] = A0G(v3g, (Object[]) obj2, i5, 0);
                if (i4 == i6) {
                    break;
                }
                i4--;
        ...
        Object obj3 = A0H2[i3];
        0qQ.A0C(obj3, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
        A0H2[i3] = A0G(v3g, (Object[]) obj3, i5, i2);
        return A0H2;
    }
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [java.util.AbstractList, X.TqS] */
    public final int A0O() {
        return this.modCount;
    }

    /* JADX WARNING: type inference failed for: r0v1, types: [X.6GA, java.lang.Object] */
    public final AnonymousClass62O AEK() {
        AnonymousClass62O r2;
        AnonymousClass62O r22;
        Object[] objArr = this.A03;
        if (objArr == this.A06 && this.A04 == this.A07) {
            ...
            this.A07 = objArr2;
            if (objArr != null) {
                r2 = new C14128TqN(objArr, objArr2, size(), this.A00);
            } else if (objArr2.length == 0) {
                r22 = AnonymousClass62M.A01;
            } else {
                r2 = new AnonymousClass62M(C13988Tno.A1b(objArr2, size()));
            }
            r22 = r2;
        }
        this.A05 = r22;
    ...
    /* JADX WARNING: type inference failed for: r5v0, types: [java.util.AbstractCollection, java.util.AbstractList, X.TqS] */
    ...
    /* JADX WARNING: type inference failed for: r6v0, types: [java.util.AbstractCollection, X.TqS] */
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [java.util.AbstractCollection, X.TqS] */
    ...
    private final java.lang.Object[] A0K(java.lang.Object[] r5, java.lang.Object[] r6, int r7) {
        ...
        L_0x0017:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C14133TqS.A0K(java.lang.Object[], java.lang.Object[], int):java.lang.Object[]");
    }
    ...
    private final Object[] A0L(Object[] objArr, Object[][] objArr2, int i) {
        ...
        while (A002.hasNext()) {
            ...
            objArr4[32] = this.A02;
            objArr3 = objArr4;
            A0E(A002, objArr4, 1 << i4, i4);
        }
        return objArr3;
    }

    /* JADX WARNING: type inference failed for: r2v0, types: [java.lang.Object, X.V3G] */
    public final Object A0N(int i) {
        AnonymousClass6BV.A00(i, size());
        this.modCount++;
        int A002 = A00();
        if (i >= A002) {
            return A03(this.A03, A002, this.A00, i - A002);
        }
        Object obj = this.A04[0];
        ? obj2 = new Object();
        obj2.A00 = obj;
        Object[] objArr = this.A03;
        0qQ.A0A(objArr);
        A03(A0G(obj2, objArr, this.A00, i), A002, this.A00, 0);
        return obj2.A00;
    }

    /* JADX WARNING: type inference failed for: r3v0, types: [java.util.AbstractCollection, X.TqS] */
    ...
    public final void add(int i, Object obj) {
        ...
        Object[] objArr = this.A03;
        0qQ.A0A(objArr);
        A05(obj3.A00, A0C(obj2, obj3, objArr, this.A00, i2), 0);
    }

    /* JADX WARNING: type inference failed for: r6v0, types: [java.util.AbstractCollection, java.util.AbstractList, X.TqS] */
    public final boolean addAll(int i, Collection collection) {
        Object[] A0B;
        int i2 = i;
        Collection collection2 = collection;
        0qQ.A0B(collection2, 1);
        AnonymousClass6BV.A01(i2, size());
        if (i2 == size()) {
