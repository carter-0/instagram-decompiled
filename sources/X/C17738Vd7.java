...
/* renamed from: X.Vd7  reason: case insensitive filesystem */
public final class C17738Vd7 {
    public int A00;
    public int A01;
    public Estimate A02;
    public C45267CtW A03;
    public XFBCTXWelcomeMessageStatus A04;
    public XIGIGBoostCallToAction A05;
    public XIGIGBoostDestination A06;
    public AdCreativeAuthorizationCategory A07;
    public IGBoostPackagesFlowInfo A08;
    public PromoteAudience A09;
    public String A0A;
    public String A0B;
    public String A0C;
    public String A0D;
