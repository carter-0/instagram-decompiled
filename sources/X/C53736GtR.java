...
public final class C53736GtR extends C251343mx {
    public final UserSession A00;
    public final C242813Wa A01;
    public final User A02;
    public final String A03;

    public C53736GtR(UserSession userSession, C242813Wa r3, User user, String str) {
        0qQ.A0B(user, 4);
        this.A03 = str;
        this.A01 = r3;
    ...
    public final C251263mp A0X(AnonymousClass3Y5 r12) {
        ...
        2WX A0Z = C51971G9r.A0Z(C51971G9r.A0Y(C51972G9s.A0V(C51971G9r.A0Y(A0X, num, drawable, 4), new J6K(this, 35)), AnonymousClass05K.A0D, Integer.valueOf(R.id.feed_opal_indicator_component), 4), AnonymousClass05K.A0Y, J6S.A00(r12, this, 35), (String) null);
