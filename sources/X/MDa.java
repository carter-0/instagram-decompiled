...
public final class MDa extends C64101El {
    public int A00;
    public int A01;
    public int A02;
    public int A03;
    ...
    public MDa(SeparatorState separatorState, AnonymousClass4D7 r2) {
        super(r2);
        this.A0G = separatorState;
    }

    /* JADX WARNING: type inference failed for: r2v0, types: [X.MDa, X.4D7] */
