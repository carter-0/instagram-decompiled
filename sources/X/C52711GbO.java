...
public final class C52711GbO {
    ...
    public final C52710GbN A0I;
    public final CharSequence A0J;
    public final boolean A0K;
    public final boolean A0L;

    public C52711GbO(ColorStateList colorStateList, ColorStateList colorStateList2, Rect rect, Typeface typeface, Drawable drawable, Drawable drawable2, Editable editable, TextUtils.TruncateAt truncateAt, KeyListener keyListener, C52710GbN gbN, CharSequence charSequence, float f, float f2, float f3, float f4, int i, int i2, int i3, int i4, int i5, boolean z, boolean z2) {
        this.A0F = editable;
        this.A03 = f;
