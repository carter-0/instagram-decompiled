...
public abstract /* synthetic */ class C44403CeN {
    public static Map A00(C283395Hm r4) {
        ...
        if (r4.Av0() != null) {
            A1H.put(C273654mx.A00(2232), r4.Av0());
        }
        if (r4.AyE() != null) {
        ...
        String str = null;
        if (r4.BCV() != null) {
            C283375Hk BCV = r4.BCV();
            if (BCV != null) {
                treeUpdaterJNI2 = BCV.FHC();
            } else {
                treeUpdaterJNI2 = null;
            }
            A1H.put("hashtag", treeUpdaterJNI2);
        }
        if (r4.BCt() != null) {
