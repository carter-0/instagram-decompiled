...
public abstract class AnonymousClass7A3 {
    ...
    static {
        ...
        System.arraycopy(new String[]{"ER", "AW", "FO", "GL", "GI", "PT", "LU", "IE", "IS", "AL", "MT", "CY", "FI", "AX", "BG", "LT", "LV", "EE", "MD", "AM", "BY", "AD", "MC", "SM", "VA", "UA", "RS"}, 0, strArr, 135, 27);
        System.arraycopy(new String[]{"ME", "HR", "SI", "BA", "MK", "CZ", "SK", "LI", "FK", "BZ", "GT", "SV", "HN", "NI", "CR", "PA", "PM", "HT", "GP", "BL", "MF", "BO", "GY", "EC", "GF", "PY", "MQ"}, 0, strArr, 162, 27);
        String str = "001";
        System.arraycopy(new String[]{"SR", "UY", "CW", "BQ", "TL", "NF", "BN", "NR", "PG", "TO", "SB", "VU", "FJ", "PW", "WF", "CK", "NU", "WS", "KI", "NC", "TV", "PF", "TK", "FM", "MH", "001", str}, 0, strArr, 189, 27);
        System.arraycopy(new String[]{"KP", "HK", "MO", "KH", "LA", "001", str, "BD", "001", "001", "001", "TW", "001", "MV", "LB", "JO", "SY", "IQ", "KW", "SA", "YE", "OM", "PS", "AE", "IL", "BH", "QA"}, 0, strArr, 216, 27);
