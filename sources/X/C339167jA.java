...
public final class C339167jA extends Drawable {
    ...
    public C339167jA(Context context, int i, int i2, boolean z, boolean z2, boolean z3) {
        0qQ.A0B(context, 1);
        this.A0A = z;
        this.A09 = z2;
        this.A00 = z3;
        ...
        this.A05 = paint;
        float dimensionPixelSize = (float) resources.getDimensionPixelSize(R.dimen.abc_button_padding_horizontal_material);
    ...
    public final float A00() {
        ...
        return (float) this.A04.getDimensionPixelSize(this.A02);
    }
