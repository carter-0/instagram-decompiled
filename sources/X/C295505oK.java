...
public abstract class C295505oK {
    ...
    public static void A0E(Parcel parcel, int i, int i2) {
        if (i != i2) {
            ...
            sb.append(AnonymousClass000.A00(940));
            sb.append(i2);
            sb.append(" got ");
            sb.append(i);
            sb.append(" (0x");
            sb.append(hexString);
            sb.append(")");
            throw new TQZ(parcel, sb.toString());
        }
    }
    ...
    public static int A00(Parcel parcel) {
        ...
        if (c == 20293) {
            ...
            throw new TQZ(parcel, 002.A02(dataPosition, i, "Size read is invalid start=", " end="));
        }
        throw new TQZ(parcel, "Expected object header. Got 0x".concat(String.valueOf(Integer.toHexString(readInt))));
    }
    ...
    public static void A0B(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new TQZ(parcel, 002.A0O(Pxd.A00(546), i));
        }
    }
