...
public final class PzA {
    ...
    public static SJT A00(ShortcutInfo shortcutInfo) {
        String string;
        if (Build.VERSION.SDK_INT < 29) {
            ...
            return new SJT(string);
        } else if (shortcutInfo.getLocusId() == null) {
            return null;
        } else {
            return SJT.A00(shortcutInfo.getLocusId());
        }
    }
    ...
    public final ShortcutInfo A01() {
        ...
        if (iconCompat != null) {
            intents.setIcon(C66773McJ.A00(this.A05, iconCompat));
        }
        ...
        if (i >= 29) {
            AH5[] ah5Arr = this.A0Q;
            if (ah5Arr != null && (length2 = ah5Arr.length) > 0) {
                Person[] personArr = new Person[length2];
                int i2 = 0;
                do {
                    personArr[i2] = AAA.A00(this.A0Q[i2]);
                    i2++;
                } while (i2 < length2);
            ...
            SJT sjt = this.A08;
            if (sjt != null) {
                intents.setLocusId(sjt.A01());
            }
            intents.setLongLived(this.A0N);
            if (i >= 33) {
                PzI.A00(intents, this.A01);
            }
        } else {
            ...
            AH5[] ah5Arr2 = this.A0Q;
            if (ah5Arr2 != null && (length = ah5Arr2.length) > 0) {
                persistableBundle2.putInt("extraPersonCount", length);
                int i3 = 0;
                while (true) {
                    AH5[] ah5Arr3 = this.A0Q;
                    if (i3 >= ah5Arr3.length) {
                        break;
                    }
                    PersistableBundle persistableBundle3 = this.A06;
                    int i4 = i3 + 1;
                    String A0O2 = 002.A0O("extraPerson_", i4);
                    AH5 ah5 = ah5Arr3[i3];
                    PersistableBundle persistableBundle4 = new PersistableBundle();
                    CharSequence charSequence = ah5.A01;
                    ...
                    persistableBundle4.putString("uri", ah5.A03);
                    persistableBundle4.putString("key", ah5.A02);
                    persistableBundle4.putBoolean("isBot", ah5.A04);
                    persistableBundle4.putBoolean("isImportant", ah5.A05);
                    persistableBundle3.putPersistableBundle(A0O2, persistableBundle4);
                    i3 = i4;
                }
            }
            SJT sjt2 = this.A08;
            if (sjt2 != null) {
                this.A06.putString("extraLocusId", sjt2.A00);
            }
