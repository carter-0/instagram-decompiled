...
public abstract class C49116Epf {
    public static final 1OC A00(UserSession userSession, Integer num, String str, String str2) {
        ...
        DbU.A1P(A0b, "third_party_sharing/%s/get_audio_to_share_url/", new Object[]{str});
        A0b.A0C = "create_audio_share_url";
        ...
        return DbU.A0S(A0b, DvD.class, F7L.class);
    }
}
