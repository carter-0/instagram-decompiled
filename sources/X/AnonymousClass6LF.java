...
public abstract class AnonymousClass6LF {
    public static AnonymousClass6LI parseFromJson(16F r25) {
        String str;
        16F r2 = r25;
        0qQ.A0B(r2, 0);
        try {
            ...
            while (r2.A1J() != 16L.A09) {
                ...
                if ("attribution".equals(A0q)) {
                    ...
                    r6 = AnonymousClass6LG.parseFromJson(r2);
            ...
            return new AnonymousClass6LI(stickerTraySurface, subscriptionStickerDict, r6, f, f2, f3, f4, f5, f6, f7, f8, num, num2, num3, num4, num5, str2, str3, str4, str5, str6, str7);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
