...
public abstract class W13 {
    ...
    public static final void A00(Canvas canvas, Paint paint, RectF rectF) {
        ...
        path2.cubicTo(0.05f, 38.15f, 0.01f, 37.08f, 0.0f, 31.02f);
        ...
        Path path4 = path;
        path4.cubicTo(42.87f, 50.22f, 44.12f, 49.96f, 45.29f, 49.5f);
        path4.cubicTo(46.34f, 49.1f, 47.04f, 48.64f, 47.84f, 47.84f);
        path.cubicTo(48.64f, 47.04f, 49.1f, 46.33f, 49.5f, 45.29f);
        path4.cubicTo(49.99f, 44.05f, 50.26f, 42.7f, 50.35f, 40.61f);
        path4.cubicTo(50.44f, 38.74f, 50.48f, 37.57f, 50.5f, 35.54f);
        ...
        Path path5 = path;
        path5.cubicTo(41.89f, 36.09f, 36.08f, 41.89f, 28.92f, 41.89f);
        path5.cubicTo(21.76f, 41.89f, 15.96f, 36.09f, 15.96f, 28.92f);
        path.cubicTo(15.96f, 21.76f, 21.76f, 15.96f, 28.92f, 15.96f);
        path.close();
        A02(canvas2, paint2, rectF, 58.0f);
        canvas2.restore();
    }
    ...
    public static final void A01(Canvas canvas, Paint paint, RectF rectF) {
        ...
        Path path2 = path;
        path2.cubicTo(39.14f, 17.85f, 40.15f, 18.86f, 40.63f, 20.16f);
        Path path3 = path;
        path3.cubicTo(41.0f, 21.34f, 41.0f, 22.44f, 41.0f, 24.64f);
        path.lineTo(41.0f, 33.36f);
        path3.cubicTo(41.0f, 35.56f, 41.0f, 36.66f, 40.67f, 37.65f);
        path.lineTo(40.63f, 37.84f);
        Path path4 = path;
        path4.cubicTo(40.15f, 39.14f, 39.14f, 40.15f, 37.84f, 40.63f);
        path4.cubicTo(36.66f, 41.0f, 35.56f, 41.0f, 33.36f, 41.0f);
        path.lineTo(24.64f, 41.0f);
        path4.cubicTo(22.44f, 41.0f, 21.34f, 41.0f, 20.35f, 40.67f);
        path.lineTo(20.16f, 40.63f);
        path.cubicTo(18.86f, 40.15f, 17.85f, 39.14f, 17.37f, 37.84f);
        Path path5 = path;
        path5.cubicTo(17.0f, 36.66f, 17.0f, 35.56f, 17.0f, 33.36f);
        path.lineTo(17.0f, 24.64f);
        path5.cubicTo(17.0f, 22.44f, 17.0f, 21.34f, 17.33f, 20.35f);
        path.lineTo(17.37f, 20.16f);
        path2.cubicTo(17.85f, 18.86f, 18.86f, 17.85f, 20.16f, 17.37f);
        ...
        Path path6 = path;
        path6.cubicTo(58.0f, 11.65f, 58.0f, 14.6f, 58.0f, 20.51f);
        path.lineTo(58.0f, 37.49f);
        path6.cubicTo(58.0f, 43.4f, 58.0f, 46.35f, 57.12f, 49.01f);
        path.lineTo(57.0f, 49.53f);
        Path path7 = path;
        path7.cubicTo(55.73f, 53.0f, 53.0f, 55.73f, 49.53f, 57.0f);
        path7.cubicTo(46.35f, 58.0f, 43.4f, 58.0f, 37.49f, 58.0f);
        ...
        Path path8 = path;
        path8.cubicTo(0.0f, 46.35f, 0.0f, 43.4f, 0.0f, 37.49f);
        path.lineTo(0.0f, 20.51f);
        path8.cubicTo(0.0f, 14.6f, 0.0f, 11.65f, 0.88f, 8.99f);
    ...
    public static final void A02(Canvas canvas, Paint paint, RectF rectF, float f) {
        Matrix matrix = A01;
        matrix.reset();
