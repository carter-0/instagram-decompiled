...
public abstract class C44530CgQ {
    public static C42118BHw parseFromJson(16F r25) {
        String str;
        16F r2 = r25;
        0qQ.A0B(r2, 0);
        try {
            ...
            while (r2.A1J() != 16L.A09) {
                ...
                } else if (AnonymousClass000.A00(379).equals(A0q)) {
                    bHv = D0D.parseFromJson(r2);
            ...
            return new C42118BHw(stickerTraySurface, subscriptionStickerDict, bHv, f, f2, f3, f4, f5, f6, f7, f8, num, num2, num3, num4, num5, str2, str3, str4, str5, str6, str7);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
