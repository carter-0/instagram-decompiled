...
public abstract class C44637CiG {
    public static C47184Drz parseFromJson(16F r13) {
        ...
        try {
            ...
            if (str == null && (r13 instanceof 0c9)) {
                AnonymousClass7TF.A1L(DevServerEntity.COLUMN_DESCRIPTION, r13, "InsightsComponent");
            } else if (num == null && (r13 instanceof 0c9)) {
                AnonymousClass7TF.A1L("index", r13, "InsightsComponent");
            } else if (arrayList == null && (r13 instanceof 0c9)) {
                AnonymousClass7TF.A1L("themed_image_url", r13, "InsightsComponent");
            } else if (str2 != null || !(r13 instanceof 0c9)) {
                return new C47184Drz(str, str2, (List) arrayList, num.intValue(), 2);
            } else {
                AnonymousClass7TF.A1L(DialogModule.KEY_TITLE, r13, "InsightsComponent");
            }
