...
public abstract class AnonymousClass7A2 {
    ...
    static {
        ...
        System.arraycopy(new String[]{"MD", "ME", "MF", "MG", "MH", "MK", "ML", "MM", "MN", "MO", "MP", "MQ", "MR", "MS", "MT", "MU", "MV", "MW", "MX", "MY", "MZ", "NA", "NC", "NE", "NF", "NG", "NI"}, 0, strArr, 135, 27);
        System.arraycopy(new String[]{"NL", "NO", "NP", "NR", "NU", "NZ", "OM", "PA", "PE", "PF", "PG", "PH", "PK", "PL", "PM", "PR", "PS", "PT", "PW", "PY", "QA", "RE", "RO", "RS", "RU", "RW", "SA"}, 0, strArr, 162, 27);
