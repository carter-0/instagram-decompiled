...
public final class W0Q {
    ...
    private boolean A01(Context context) {
        ...
        return !context.isRestricted() && AnonymousClass3U3.A03(context, new TypedValue(), (AnonymousClass3U1) null, i, 0, false, true) != null;
    }

    public final void A05(Context context, V4P v4p) {
        ...
        if (this.A02) {
            v4p.A01(this.A01, true);
            return;
        }
        try {
            C14304Tte tte = new C14304Tte(this, v4p);
            if (context.isRestricted()) {
                tte.A00(-4);
            } else {
                AnonymousClass3U3.A03(context2, new TypedValue(), tte, i, 0, false, false);
            }
    ...
    public static void A00(W0Q w0q) {
        Typeface typeface;
        String str;
        Typeface typeface2 = w0q.A01;
        if (typeface2 == null && (str = w0q.A0D) != null) {
            typeface2 = Typeface.create(str, w0q.A07);
            w0q.A01 = typeface2;
        }
        if (typeface2 == null) {
            int i = w0q.A08;
            ...
            w0q.A01 = typeface;
            w0q.A01 = Typeface.create(typeface, w0q.A07);
        }
    }
    ...
    public final Typeface A02(Context context) {
        ...
        if (!context.isRestricted()) {
            try {
                Typeface A022 = AnonymousClass3U3.A02(context, this.A0F);
                this.A01 = A022;
                if (A022 != null) {
                    this.A01 = Typeface.create(A022, this.A07);
                }
    ...
    public W0Q(Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i, C297865sU.A0b);
        this.A00 = obtainStyledAttributes.getDimension(0, 0.0f);
        this.A0A = C309286Xr.A01(context, obtainStyledAttributes, 3);
        this.A0B = C309286Xr.A01(context, obtainStyledAttributes, 4);
        this.A0C = C309286Xr.A01(context, obtainStyledAttributes, 5);
        ...
        this.A09 = C309286Xr.A01(context, obtainStyledAttributes, 6);
        ...
        TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(i, C297865sU.A0R);
        this.A0E = obtainStyledAttributes2.hasValue(0);
        this.A03 = obtainStyledAttributes2.getFloat(0, 0.0f);
        obtainStyledAttributes2.recycle();
    }

    public final void A03(Context context, TextPaint textPaint, V4P v4p) {
        int i;
        int i2;
        A04(context, textPaint, v4p);
    ...
    public final void A04(Context context, TextPaint textPaint, V4P v4p) {
        if (A01(context)) {
