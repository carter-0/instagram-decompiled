...
public abstract class C49792F7a {
    public static void A01(1Fa r3, UserSession userSession, Integer num, String str) {
        r3.A9m("share_to_app", A00(num));
        r3.A9m("containermodule", str);
        r3.A0H("exposed_to_experiment", FGA.A03(userSession));
    }
    ...
    public static String A00(Integer num) {
        switch (num.intValue()) {
            ...
            case 22:
                return "ig_feed";
            case 23:
                return AnonymousClass000.A00(3312);
            case 24:
