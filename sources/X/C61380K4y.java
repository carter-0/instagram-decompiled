...
public final class C61380K4y extends AnonymousClass4DH implements AnonymousClass4DS {
                ...
                if (igdsHeadline2 != null) {
                    ...
                    if (igdsBottomButtonLayout != null) {
                        ...
                        if (igdsBottomButtonLayout2 != null) {
                            igdsBottomButtonLayout2.setPrimaryActionOnClickListener(new LYE((Object) this, 30));
                            IgdsBottomButtonLayout igdsBottomButtonLayout3 = this.A03;
                            if (igdsBottomButtonLayout3 != null) {
                                igdsBottomButtonLayout3.setSecondaryActionOnClickListener(new LYE((Object) this, 31));
                                return;
                            }
                        }
                    }
    ...
    public final void onCreate(Bundle bundle) {
        int A022 = AnonymousClass0fD.A02(-1686797759);
        C61380K4y.super.onCreate(bundle);
        this.A01 = 09i.A0A.A06(requireArguments());
        this.A00 = requireContext().getDrawable(R.drawable.ig_illustrations_illo_nudity_detection_refresh);
        AnonymousClass0fD.A09(1803897160, A022);
    }

    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        int A022 = AnonymousClass0fD.A02(-720902762);
        0qQ.A0B(layoutInflater, 0);
        View A0D = DbT.A0D(layoutInflater, viewGroup, R.layout.on_device_nudity_inbox_qp_cta_nux, false);
        AnonymousClass0fD.A09(729000964, A022);
        return A0D;
    }

    public final void onDestroy() {
        int A022 = AnonymousClass0fD.A02(1497412646);
        super.onDestroy();
        ...
        r0.A00.A01();
        AnonymousClass0fD.A09(-1778244796, A022);
    }
}
