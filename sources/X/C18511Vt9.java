...
public final class C18511Vt9 {
    ...
    public static Paint A00(float f, float f2, float f3, int i) {
        ...
        paint.setShader(new RadialGradient(0.0f, 0.0f, Math.max(f2, f3), new int[]{C52686Gay.A00(i, f), C52686Gay.A00(i, 0.0f)}, (float[]) null, Shader.TileMode.CLAMP));
        return paint;
    }

    public C18511Vt9(float f, float f2, int i, float f3, int i2, float f4) {
        this.A06 = i;
        this.A04 = f3;
        this.A05 = f4;
        this.A02 = f;
