...
public final class C256773wK {
    ...
    public C256773wK(String str, String str2, String str3, List list, List list2, List list3, List list4, int i, int i2, boolean z, boolean z2) {
        this.A00 = i;
        this.A01 = i2;
