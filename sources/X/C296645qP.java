...
public final class C296645qP extends C263934Nx {
    ...
    public final void A00(C58840Ae r11) {
        ...
        0qQ.A0B(r11, 0);
        0wc r112 = (0wc) r11;
        0Aj A002 = r112.A00(r112.A00, "video_viewed_time");
        if (A002.isSampled()) {
            ...
            String lowerCase2 = this.A0B.toLowerCase(locale);
            0qQ.A07(lowerCase2);
            A002.AAJ("playback_format", lowerCase2);
            A002.AAJ("tracking_token", this.A0C);
    ...
    public C296645qP(UserSession userSession, 1Xj r2, float f, int i, int i2, int i3, int i4, int i5, boolean z) {
        super(userSession);
        this.A04 = i;
        this.A00 = f;
        this.A02 = i2;
