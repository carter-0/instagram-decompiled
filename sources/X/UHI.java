...
public final class UHI extends UH2 {
    ...
    public UHI(X.WFU r19, X.UHJ r20) {
        ...
        L_0x00a7:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.UHI.<init>(X.WFU, X.UHJ):void");
    }
    ...
    public final void A0D(Canvas canvas) {
        ...
        super.A0D(canvas);
        C13989Tnp.A1L(1yR.A0M, nanoTime);
    }

    public final W1g A0H(int i, int i2, int i3) {
        W1g A0H = super.A0H(i, i2, i3);
        if (A0H != null) {
            A0H.A02 = i;
            A0H.A03 = i2;
            A0H.A04 = i3;
