...
public final class C256863wT implements C256873wU {
    public final /* synthetic */ VpsEventCallback A00;
    public final /* synthetic */ C256243vS A01;
    public final /* synthetic */ 2A4 A02;

    public C256863wT(VpsEventCallback vpsEventCallback, C256243vS r2, 2A4 r3) {
        this.A02 = r3;
    ...
    public final void ClG(String str) {
        ...
        if (str2 != null) {
            vpsEventCallback.callback(new C266454Yy(str2, "MEDIA_CODEC_RENDERER_UPGRADE", "MEDIA_CODEC_RENDERER_SUPPORT_FORMAT_CHANGE", str));
        }
    }
}
