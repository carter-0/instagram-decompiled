...
public abstract class TPF implements X509TrustManager {
    ...
    public final void checkServerTrusted(java.security.cert.X509Certificate[] r5, java.lang.String r6) {
        ...
        L_0x0017:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.TPF.checkServerTrusted(java.security.cert.X509Certificate[], java.lang.String):void");
    }
    ...
    public TPF(X509TrustManager x509TrustManager) {
        ...
        try {
            ...
            throw AnonymousClass7TE.A0z("Failure initialising sandbox TrustManager");
        }
    }
}
