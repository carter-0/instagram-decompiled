...
public abstract class C11306SKs {
    ...
    public static void A01(int i, int i2) {
        ...
        if (i < 0 || i >= i2) {
            ...
            throw Pxe.A0k(C9715RfY.A00(str, objArr));
        }
    }
        ...
        if (i >= 0) {
            ...
            if (i <= i3) {
                if (i2 < 0 || i2 > i3) {
                    ...
                    str = C9715RfY.A00("end index (%s) must not be less than start index (%s)", C51968G9o.A1Z(Integer.valueOf(i2), i));
                }
                throw Pxe.A0k(str);
            }
        }
