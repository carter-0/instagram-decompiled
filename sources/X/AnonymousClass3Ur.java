...
public final class AnonymousClass3Ur {
    ...
    public static AnonymousClass3Ur A00(Context context, AttributeSet attributeSet) {
        AnonymousClass3Ur r0;
        if (attributeSet == null) {
            return r0;
        }
        r0 = new AnonymousClass3Ur(context, attributeSet);
        return r0;
    }
    ...
    public final boolean A05(float f) {
        ...
        if (r2.A00 == AnonymousClass05K.A00 && r2.A01[0] == f) {
            return false;
        }
        r2.A06(f);
        A02();
    ...
    public final boolean A07(float f, float f2, float f3, float f4) {
        C242553Us r1 = this.A09;
        float[] fArr = r1.A01;
        if (r1.A00 != AnonymousClass05K.A0j && fArr[0] == f && fArr[2] == f2 && fArr[4] == f3 && fArr[6] == f4) {
            return false;
        }
        r1.A07(f, f2, f4, f3);
        A02();
    ...
    public AnonymousClass3Ur(Context context) {
        ...
        this.A08 = new RectF();
        this.A07 = new RectF();
        this.A09 = new C242553Us();
        this.A02 = (float) context.getResources().getDimensionPixelSize(R.dimen.action_bar_item_spacing_left);
    ...
    public AnonymousClass3Ur(Context context, AttributeSet attributeSet) {
        this.A04 = new Paint(1);
        this.A03 = new Paint(1);
        this.A06 = new Path();
        this.A05 = new Path();
        this.A08 = new RectF();
        this.A07 = new RectF();
        C242553Us r5 = new C242553Us();
        this.A09 = r5;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C71382cm.A22);
        ...
        r5.A07((float) obtainStyledAttributes.getDimensionPixelOffset(4, dimensionPixelSize), (float) obtainStyledAttributes.getDimensionPixelOffset(5, dimensionPixelSize), (float) obtainStyledAttributes.getDimensionPixelOffset(2, dimensionPixelSize), (float) obtainStyledAttributes.getDimensionPixelOffset(3, dimensionPixelSize));
        this.A02 = (float) obtainStyledAttributes.getDimensionPixelOffset(7, context.getResources().getDimensionPixelSize(R.dimen.action_bar_item_spacing_left));
