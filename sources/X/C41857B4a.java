...
public final class C41857B4a extends C66675Mai {
    ...
    public final void A00(AnonymousClass3JD r5, UserSession userSession) {
        ...
        if (r5 == null || (A0U = C41845B3m.A0U(r5)) == null) {
            ...
            bool = C41846B3n.A0d(A0U, "xig_direct_item_seen(data:$data,metadata:$metadata)", 0);
        }
    ...
    public C41857B4a(UserSession userSession, C74551Pwk pwk) {
        super(userSession);
        this.A00 = pwk;
    }
}
