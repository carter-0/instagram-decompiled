...
public final class C285045Pl implements RandomAccess {
    public int A00 = 0;
    public List A01;
    public Object[] A02;

    public C285045Pl(Object[] objArr) {
        this.A02 = objArr;
    }
    ...
    public final void A04(int i, Object obj) {
        ...
        int i2 = this.A00;
        if (i != i2) {
            0Yw.A0V(objArr, objArr, i + 1, i, i2);
        }
        objArr[i] = obj;
        this.A00++;
    }

    public final void A06(C285045Pl r5, int i) {
        int i2 = r5.A00;
        if (i2 != 0) {
            A02(this.A00 + i2);
            Object[] objArr = this.A02;
            int i3 = this.A00;
            if (i != i3) {
                0Yw.A0V(objArr, objArr, r5.A00 + i, i, i3);
            }
            0Yw.A0V(r5.A02, objArr, i, 0, r5.A00);
            this.A00 += r5.A00;
        }
    }
    ...
    public final void A05(int i, List list) {
        if (!list.isEmpty()) {
            ...
            Object[] objArr = this.A02;
            if (i != this.A00) {
                0Yw.A0V(objArr, objArr, list.size() + i, i, this.A00);
            }
            int size = list.size();
    ...
    public final boolean A08(int i, Collection collection) {
        ...
        Object[] objArr = this.A02;
        if (i != this.A00) {
            0Yw.A0V(objArr, objArr, collection.size() + i, i, this.A00);
        }
