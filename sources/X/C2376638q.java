...
public final class C2376638q extends AnonymousClass1VF {
    public C2376638q() {
        super(13, 14);
    }
    ...
    public final void migrate(1W6 r2) {
        ...
        r2.AT6("CREATE INDEX IF NOT EXISTS `index_WorkSpec_period_start_time` ON `WorkSpec` (`period_start_time`)");
    }
}
