...
public abstract /* synthetic */ class C44528CgO {
    public static Map A00(C270034g5 r4) {
        String str;
        ...
        if (r4.C5Y() != null) {
            DTU C5Y = r4.C5Y();
            if (C5Y != null) {
                treeUpdaterJNI2 = C5Y.FHC();
            }
            A1H.put("text_post_share_to_ig_story_sticker", treeUpdaterJNI2);
        }
        if (r4.CGX() != null) {
