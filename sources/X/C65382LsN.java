...
public final class C65382LsN implements C66516MUu {
    ...
    public final Integer A01() {
        ...
        if (num == AnonymousClass05K.A00) {
            if (((S4A) this.A04.getValue()).A01(this.A02).length() == 0) {
    ...
    public C65382LsN(UserSession userSession, C64418LbZ lbZ) {
        AnonymousClass7TG.A1O(userSession, lbZ);
        this.A01 = userSession;
        this.A02 = lbZ;
        0eO r1 = 0eO.A02;
        this.A04 = MMJ.A00(this, r1, 28);
        this.A03 = MMJ.A00(this, r1, 27);
    }
    ...
    public final AnonymousClass40G EHa(List list) {
        ...
        if (A01() == AnonymousClass05K.A0C) {
            return ((C258833zi) this.A03.getValue()).E3X((C258993zy) null, list);
        }
