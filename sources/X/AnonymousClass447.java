...
public final class AnonymousClass447 implements C2598643j {
    public final 2Dm A00;

    public AnonymousClass447(2Dm r2) {
        0qQ.A0B(r2, 1);
        this.A00 = r2;
    }
    ...
    public final AnonymousClass6BN E4Y(AnonymousClass651 r16, AnonymousClass653 r17, List list, Map map, 0sL r20, 0sL r21, boolean z) {
        ...
        if (number == null) {
            ...
            return new AnonymousClass6BR(new Exception("timestamp is missing for policy violation reported"), "PolicyViolation_IrisSyncMessageProcessor", "timestamp is missing for policy violation reported");
        }
        2Dr r2 = this.A00;
            ...
            synchronized (A0P) {
                ...
                if (((Boolean) r0.A05.getValue()).booleanValue()) {
                    ...
                    try {
                        ...
                        if (r6 == null) {
                            r92 = new C300625xW(longValue, 0, "UNKNOWN");
                        } else {
                            r92 = new C300625xW(longValue, r6.A01, r6.A00());
                        }
                        r52.A0r = r92;
                        while (i2 < i) {
                            readLock.lock();
                    ...
                    synchronized (r42) {
                        try {
                            ...
                            if (r34 == null) {
                                r9 = new C300625xW(longValue, 0, "UNKNOWN");
                            } else {
                                r9 = new C300625xW(longValue, r34.A01, r34.A00());
                            }
                            r42.A0r = r9;
                        } catch (Throwable th3) {
                            th = th3;
