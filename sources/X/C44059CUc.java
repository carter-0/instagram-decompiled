...
public abstract class C44059CUc {
    public static N49 parseFromJson(16F r8) {
        ...
        try {
            ...
            if (str == null && (r8 instanceof 0c9)) {
                AnonymousClass7TF.A1L(PublicKeyCredentialControllerUtility.JSON_KEY_ID, r8, "AudienceInterest");
            } else if (str2 != null || !(r8 instanceof 0c9)) {
                return new N49(str, str2, 6);
            } else {
                AnonymousClass7TF.A1L(PublicKeyCredentialControllerUtility.JSON_KEY_NAME, r8, "AudienceInterest");
            }
