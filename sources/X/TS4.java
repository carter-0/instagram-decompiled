...
public class TS4<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    public List A00 = Collections.emptyList();
    public Map A01 = Collections.emptyMap();
    public boolean A02;
    public Map A03 = Collections.emptyMap();
    public final int A04;
    public volatile TSL A05;
    ...
    public final boolean equals(Object obj) {
        ...
        if (size == ts4.size()) {
            ...
            if (size2 != ts4.A00.size()) {
                return entrySet().equals(ts4.entrySet());
            }
            int i = 0;
            while (i < size2) {
                if (((Map.Entry) this.A00.get(i)).equals(ts4.A00.get(i))) {
                    i++;
                }
            }
            if (size2 != size) {
                return this.A01.equals(ts4.A01);
            }
            return true;
        }
        return false;
    ...
    private int A00(Comparable comparable) {
        ...
        if (A06 >= 0) {
            int compareTo = comparable.compareTo(((C13134TMs) this.A00.get(A06)).A01);
            if (compareTo > 0) {
                i = A06 + 2;
                return -i;
            } else if (compareTo == 0) {
        ...
        while (i2 <= A06) {
            int i3 = (i2 + A06) / 2;
            int compareTo2 = comparable.compareTo(((C13134TMs) this.A00.get(i3)).A01);
            if (compareTo2 < 0) {
                A06 = i3 - 1;
    ...
    public static void A03(TS4 ts4) {
        if (ts4.A02) {
            throw C66580MXl.A11();
        }
    }
    ...
    public final Object get(Object obj) {
        ...
        if (A002 >= 0) {
            return ((C13134TMs) this.A00.get(A002)).getValue();
        }
    ...
    public static Object A01(TS4 ts4, int i) {
        A03(ts4);
        Object value = ((C13134TMs) ts4.A00.remove(i)).getValue();
        if (!ts4.A01.isEmpty()) {
            Iterator it = ts4.A02().entrySet().iterator();
            List list = ts4.A00;
            Map.Entry A1J = AnonymousClass7TE.A1J(it);
            list.add(new C13134TMs(ts4, (Comparable) A1J.getKey(), A1J.getValue()));
            it.remove();
        }
        return value;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int A002 = A00(comparable);
        if (A002 >= 0) {
            return ((C13134TMs) this.A00.get(A002)).setValue(obj);
        }
        A03(this);
        ...
        if (this.A00.size() == i2) {
            C13134TMs tMs = (C13134TMs) this.A00.remove(i2 - 1);
            A02().put(tMs.A01, tMs.getValue());
        }
        this.A00.add(i, new C13134TMs(this, comparable, obj));
        return null;
    }
