...
/* renamed from: X.Y0x  reason: case insensitive filesystem */
public final class C22369Y0x implements G8I {
    public final CTU A00;

    public C22369Y0x(CTU ctu) {
        0qQ.A0B(ctu, 1);
        this.A00 = ctu;
    }
    ...
    public final G9S B8C() {
        return C21055XCg.A0G(this.A00.A01, C43695C5r.class, 1195986619);
    }
    ...
    public final int BCX() {
        return this.A00.A01.getCoercedIntField(8, AnonymousClass000.A00(1406));
    }
    ...
    public final List Bey() {
        ImmutableList optionalCompactedTreeListField = this.A00.A01.getOptionalCompactedTreeListField(9, AnonymousClass000.A00(1701), C43698C5u.class, -22302801);
