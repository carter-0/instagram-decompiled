...
public final class AnonymousClass79I {
    public static final AnonymousClass79J A02 = new Object();
    public static volatile AnonymousClass79I A03;
    ...
    public final void A00(Window window) {
        ...
        if (z3 != z2) {
            0KC.A02(getClass(), 002.A1C("Inconsistency in window FLAG_SECURE state detected! window state: ", ", internal state: ", z3, z2));
            Iterable iterable = (Iterable) this.A00.get(window);
            if (iterable != null) {
                00k.A0P(",", "", "", iterable, (0sP) null);
            }
            ...
            } else if (attributes2 != null && (attributes2.flags & 8192) != 0) {
