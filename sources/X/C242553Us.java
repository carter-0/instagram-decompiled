...
public final class C242553Us {
    public static final C242553Us A02 = new C242553Us();
    public Integer A00 = AnonymousClass05K.A00;
    public final float[] A01 = new float[AnonymousClass05K.A00(8).length];

    public final boolean equals(Object obj) {
        if (this == obj) {
            return true;
        }
        if (obj instanceof C242553Us) {
            C242553Us r5 = (C242553Us) obj;
            return Arrays.equals(this.A01, r5.A01) && this.A00 == r5.A00;
        }
        return false;
    }

    public static void A01(C242553Us r6) {
        Integer num;
        if (r6 != A02) {
            if (r6.A02()) {
    ...
    public final C242553Us A04() {
        C242553Us r4 = new C242553Us();
        float[] fArr = this.A01;
        System.arraycopy(fArr, 0, r4.A01, 0, fArr.length);
        r4.A00 = this.A00;
        return r4;
    }
    ...
    public final void A08(C242553Us r5, Integer num) {
        int length;
        float[] fArr = r5.A01;
        if (this != A02) {
            int A002 = A00(num);
            ...
            System.arraycopy(fArr, A002, this.A01, A002, length);
            A01(this);
        }
    }
    ...
    public static int A00(Integer num) {
        ...
        return C328647Fp.A00(num2);
    }

    public final C242553Us A05() {
        C242553Us A04 = A04();
        float[] fArr = A04.A01;
        float f = fArr[0];
