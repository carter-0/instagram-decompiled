...
public abstract class I36 {
    public static final void A00(C286575Wy r13, int i) {
        ...
        if (i != 0 || !r13.Bwn()) {
            if (0fL.A02()) {
                0fL.A01(1335874354, "com.instagram.schools.channels.ui.ShimmerThreadRow (ShimmerThreadRow.kt:30)");
            }
    ...
    public static final void A01(C286575Wy r7, Modifier modifier, int i) {
        ...
        if ((i2 & 11) != 2 || !r7.Bwn()) {
            if (0fL.A02()) {
                0fL.A01(1946165707, "com.instagram.schools.channels.ui.CircularImageShimmer (ShimmerThreadRow.kt:44)");
            }
    ...
    public static final void A02(C286575Wy r2, Modifier modifier, int i) {
        ...
        if ((i2 & 11) != 2 || !r2.Bwn()) {
            if (0fL.A02()) {
                0fL.A01(1186338095, "com.instagram.schools.channels.ui.TextShimmer (ShimmerThreadRow.kt:55)");
            }
