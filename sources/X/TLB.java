...
public final class TLB implements Runnable, SurfaceTexture.OnFrameAvailableListener {
        ...
        if (eglGetDisplay != null) {
            ...
            if (EGL14.eglInitialize(eglGetDisplay, iArr3, 0, iArr3, 1)) {
                ...
                if (!eglChooseConfig || iArr4[0] <= 0 || (eGLConfig = eGLConfigArr[0]) == null) {
                    throw new RuntimeException(String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", new Object[]{Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr4[0]), eGLConfigArr[0]}));
                }
                ...
                if (eglCreateContext != null) {
                    ...
                    if (EGL14.eglMakeCurrent(eGLDisplay2, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext)) {
                        ...
                        throw new RuntimeException(002.A0R("glGenTextures failed. Error: ", Integer.toHexString(glGetError)));
                    }
