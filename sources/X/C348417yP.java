...
public final class C348417yP extends Drawable {
    public int A00;
    public Bitmap A01;
    ...
    public C348417yP(Context context, Bitmap bitmap, float f, float f2, int i, int i2, boolean z) {
        0qQ.A0B(bitmap, 7);
        this.A09 = z;
        this.A02 = f2;
        int i3 = i;
        ...
        1MF.A0J(matrix, width, height, i3, i3, i2, false);
        ...
        paint3.setColor(-1);
        paint3.setShadowLayer(0nA.A04(context, 10), 0.0f, 0.0f, context.getColor(R.color.black_15_transparent));
        Paint paint4 = new Paint(1);
        this.A06 = paint4;
        paint4.setStyle(style);
        paint4.setColor(-1);
        paint4.setShadowLayer(0nA.A04(context, 1), 0.0f, 0.0f, context.getColor(R.color.black_20_transparent));
    }

    /* JADX WARNING: Code restructure failed: missing block: B:5:0x0054, code lost:
        if (r0.getHeight() != r13.getHeight()) goto L_0x0056;
     */
    ...
    public final void draw(android.graphics.Canvas r13) {
        ...
        L_0x00ad:
            ...
            goto L_0x0085
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C348417yP.draw(android.graphics.Canvas):void");
    }
