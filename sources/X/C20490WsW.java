...
public final class C20490WsW implements C255533uI {
    public static final C20490WsW A00;
    ...
    public final /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        ...
        while (true) {
            ...
            if (ANp == -1) {
                ADI.AST(r5);
                return new DTApplication(str, i);
            } else if (ANp == 0) {
                str = ADI.AOA(r5, 0);
                i |= 1;
            } else {
    ...
    static {
        ? obj = new Object();
        A00 = obj;
        C255543uJ A0g = C13990Tnq.A0g("com.facebook.neko.directinstall.digitalturbine.DTApplication", obj);
        A0g.A00("packageName");
        A01 = A0g;
    }
    ...
    public final /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        ...
        AnonymousClass7TG.A1N(encoder, dTApplication);
        C255543uJ r2 = A01;
        C13990Tnq.A1T(dTApplication.A00, r2, encoder.ADJ(r2));
    }
