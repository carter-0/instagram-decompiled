...
public final class AnonymousClass8ZG {
    public Drawable A00;
    public Drawable A01;
    public AnonymousClass8ZK A02;
    public Integer A03;
    public Integer A04;
    public Integer A05;
    public Integer A06;
    ...
    public AnonymousClass8ZG(Context context) {
        0qQ.A0B(context, 1);
        this.A0G = context;
    }

    public final AnonymousClass8ZI A00() {
        int i;
        ...
        int i2;
        AnonymousClass8ZH r8;
        Context context = this.A0G;
        int color = context.getColor(2Yu.A0H(context, R.attr.musicCreationPlayIconColor));
        ...
        if (drawable == null) {
            drawable = new C14174TrC(context);
        }
        ...
        if (this.A0E) {
            r8 = AnonymousClass8ZH.AUTO_PLAY;
        } else {
            r8 = AnonymousClass8ZH.PLAY;
        }
        return new AnonymousClass8ZI(context, paint, drawable, drawable2, this.A02, r8, num8, dimensionPixelSize, dimensionPixelSize2, dimensionPixelSize3, dimensionPixelSize4, intValue, intValue2, dimensionPixelSize5, dimensionPixelSize6, i2, color);
    }
