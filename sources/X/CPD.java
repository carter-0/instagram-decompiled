...
public final class CPD extends 17P implements XB2 {
    public SubscriptionStickerDictIntf A00;
    public StoryMusicPickTappableDataIntf A01;

    public final StoryMusicPickTappableDataIntf BUv() {
    ...
    public final X.BH3 FAX(X.1E9 r25) {
        /*
            ...
            com.instagram.api.schemas.StoryMusicPickTappableDataIntf r1 = r0.BUv()
            r3 = 0
            r2 = r25
            if (r1 == 0) goto L_0x003f
            com.instagram.api.schemas.StoryMusicPickTappableData r3 = r1.FAV(r2)
        L_0x003f:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: X.CPD.FAX(X.1E9):X.BH3");
    }

    /* JADX WARNING: type inference failed for: r1v0, types: [com.facebook.pando.TreeJNI, X.XB2, X.CPD] */
    public final TreeUpdaterJNI FHC() {
        TreeUpdaterJNI treeUpdaterJNI = TreeUpdaterJNI.$redex_init_class;
        return C41845B3m.A0S(this, V8E.A00(this));
    }
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [com.facebook.pando.TreeJNI, X.CPD] */
    ...
    public final XB2 E8l(1E9 r3) {
        StoryMusicPickTappableDataIntf BUv = BUv();
    ...
    public final BH3 FAY(1E6 r2) {
        return FAX(C41846B3n.A0S(r2));
    }
