...
public final class C22014Xr7 {
    public static final C22014Xr7 A00 = new Object();

    public static final Bitmap A00(Bitmap bitmap, List list, int i) {
        0qQ.A0B(list, 2);
        Bitmap copy = bitmap.copy(Bitmap.Config.ARGB_8888, true);
        Canvas canvas = new Canvas(copy);
        Paint A04 = C21056XCh.A04();
        for (PointF pointF : (List) list.get(i)) {
            canvas.drawPoint(pointF.x, pointF.y, A04);
        }
        0qQ.A0A(copy);
        return copy;
    }
