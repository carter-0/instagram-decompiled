...
public final class C339187jC extends C268694dq {
    ...
    public C339187jC(Context context, Integer num, int i, int i2) {
        int i3;
        int i4;
        0qQ.A0B(context, 1);
        this.A04 = context;
        ...
        gradientDrawable.setColor(context.getColor(2Yu.A0H(context, R.attr.igds_color_gradient_pink)));
        gradientDrawable.setCallback(this);
        gradientDrawable.setStroke(dimensionPixelSize, i);
        this.A07 = gradientDrawable;
        Drawable drawable = context.getDrawable(i2);
        if (drawable != null) {
            drawable.setColorFilter(AnonymousClass37O.A00(-1));
    ...
    public final List A07() {
        return 0sr.A1P(new Drawable[]{this.A07, this.A06});
    }
    ...
    public final void setAlpha(int i) {
        ...
        int i2 = this.A01;
        if (i == AnonymousClass1GB.A01(255.0f)) {
            color = this.A03;
        } else {
