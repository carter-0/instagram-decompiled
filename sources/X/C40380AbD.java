...
public final class C40380AbD implements MTZ {
    ...
    public C40380AbD(Context context, UserSession userSession, AnonymousClass4D6 r3, 1GK r4, L83 l83, FilterGroupModel filterGroupModel, AnonymousClass3Q2 r7, C352218Cl r8, Runnable runnable, boolean z, boolean z2) {
    ...
    public final void DVu(String str) {
        ...
        0Tu r15 = 0Tu.A05;
        String str2 = str;
        if (182.A06(r15, userSession, 36327709562911364L) && (decodeFile = BitmapFactory.decodeFile(str2, new BitmapFactory.Options())) != null) {
            ...
            for (int i2 = 0; i2 < width; i2++) {
                ...
                for (int i3 = 0; i3 < height; i3++) {
                    if (((long) Color.alpha(decodeFile.getPixel(i2, i3))) > 182.A01(r15, userSession, 36609184539744070L)) {
                        i++;
                    }
                }
            }
            A032.A0I = AnonymousClass7TE.A06(((float) i) / ((float) max), 100.0f);
        }
        A032.A33 = str2;
        ...
        if (this.A0A) {
            ...
            C59797JYq.A05(context2, userSession, r3, this.A03, l83, filterGroupModel, r8, r6, runnable, z);
            return;
        }
        this.A08.run();
    }
