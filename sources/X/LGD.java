...
public final class LGD {
    ...
    public LGD(View view, View view2, boolean z, boolean z2, boolean z3) {
        ...
        this.A04 = view3;
        if (constraintLayout != null) {
            textView = AnonymousClass7TE.A0d(constraintLayout, R.id.media_picker_header_title);
        } else {
            textView = null;
        }
        this.A08 = textView;
        if (constraintLayout != null) {
            textView2 = AnonymousClass7TE.A0d(constraintLayout, R.id.media_picker_subtitle);
        } else {
            textView2 = null;
        }
        this.A0A = textView2;
        if (view != null) {
            textView3 = AnonymousClass7TE.A0d(view, R.id.media_picker_subheader);
        } else {
            textView3 = null;
        }
        this.A09 = textView3;
        this.A06 = DbS.A0E(view2, R.id.media_picker_subheader_cell);
        this.A0G = DbS.A0E(view2, R.id.magic_media_remix_header);
        this.A0H = DbZ.A0F(view2, R.id.magic_media_remix_recycler_view);
        if (constraintLayout != null) {
            imageView = DbS.A0G(constraintLayout, R.id.media_picker_header_chevron);
        } else {
            imageView = null;
        }
        this.A07 = imageView;
        ...
        this.A05 = view6;
        this.A0B = constraintLayout != null ? (ToggleButton) constraintLayout.findViewById(R.id.media_picker_toggle_hd_button) : toggleButton;
        if (z2 && constraintLayout != null && textView != null) {
            ...
            A0C2.A09(R.id.media_picker_header_title, 2);
