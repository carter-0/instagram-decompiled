...
public final class C329967Kx {
    ...
    public C329967Kx(Context context, Drawable drawable, Drawable drawable2, String str, String str2, String str3, int[] iArr, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19, int i20, int i21, int i22, int i23, int i24, int i25, int i26, int i27, boolean z) {
        Drawable drawable3;
        int i28 = i5;
        this.A0O = i;
        this.A0P = i2;
        ...
        C308486Ul.A02(Paint.Style.FILL, shapeDrawable, shapeDrawable.getShape(), 0.0f, i23);
    }
}
