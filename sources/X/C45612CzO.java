...
public abstract class C45612CzO {
    public static BG6 parseFromJson(16F r25) {
        String str;
        16F r2 = r25;
        0qQ.A0B(r2, 0);
        try {
            ...
            while (r2.A1J() != 16L.A09) {
                ...
                } else if (C273654mx.A00(179).equals(A0q)) {
                    bg5 = C44292Cca.parseFromJson(r2);
            ...
            return new BG6(bg5, stickerTraySurface, subscriptionStickerDict, f, f2, f3, f4, f5, f6, f7, f8, num, num2, num3, num4, num5, str2, str3, str4, str5, str6, str7);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
    ...
    public static void A00(17Z r2, BG6 bg6) {
        r2.A0c();
        C41846B3n.A13(r2, bg6.A0G);
        C41846B3n.A16(r2, bg6.A0H);
        C41846B3n.A17(r2, bg6.A0I);
        C41846B3n.A15(r2, bg6.A0J);
        C41846B3n.A0w(r2, bg6.A03);
        C41846B3n.A0u(r2, bg6.A04);
        C41846B3n.A0y(r2, bg6.A0K);
        C41846B3n.A0o(r2, bg6.A0B);
        C41846B3n.A0l(r2, bg6.A0C);
        C41846B3n.A0m(r2, bg6.A0D);
        C41846B3n.A0n(r2, bg6.A0E);
        C41846B3n.A12(r2, bg6.A0L);
        DS2 ds2 = bg6.A00;
        if (ds2 != null) {
            r2.A0q(C273654mx.A00(179));
            BG5 F8J = ds2.F8J();
            r2.A0c();
            String str = F8J.A00;
            if (str != null) {
        ...
        C41846B3n.A0v(r2, bg6.A05);
        C41846B3n.A0x(r2, bg6.A06);
        C41846B3n.A0p(r2, bg6.A0F);
        C41846B3n.A0k(r2, bg6.A02);
        C41846B3n.A0j(r2, bg6.A01);
        C41846B3n.A0t(r2, bg6.A07);
        C41846B3n.A0q(r2, bg6.A08);
        C41846B3n.A0r(r2, bg6.A09);
        C41846B3n.A0s(r2, bg6.A0A);
        r2.A0Z();
    }
}
