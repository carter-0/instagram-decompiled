...
public abstract class C365338mw {
    /* JADX WARNING: type inference failed for: r3v0, types: [X.0r1, java.lang.Object] */
    /* JADX WARNING: type inference failed for: r4v0, types: [java.lang.Object, X.0rh] */
    ...
    public static final C367428qj A00(Gainmap gainmap, int i, int i2, int i3) {
        ...
        return new C367428qj(obj, obj2, obj6, obj3, obj4, obj5, obj8, obj7, i, i2, i3);
    }

    public static final C365348mx A01(C367428qj r4, int i, int i2, int i3) {
        return new C365348mx(r4, i, 3553, i2, i3);
    }
}
