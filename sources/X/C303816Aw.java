...
public abstract class C303816Aw {
    ...
    public static C303796Au A01(Class cls, ByteBuffer byteBuffer, int i, int i2) {
        int i3;
        int A00 = A00(byteBuffer, i, i2);
        if (A00 == 0 || (i3 = A00 + byteBuffer.getInt(A00)) == 0) {
            return null;
        }
        C303796Au r0 = (C303796Au) cls.newInstance();
        r0.ANd(byteBuffer, i3);
        return r0;
    }
    ...
    public static C303796Au[] A06(Class cls, ByteBuffer byteBuffer, int i, int i2) {
        int A00 = A00(byteBuffer, i, i2);
        if (A00 == 0) {
            return null;
        }
        int i3 = byteBuffer.getInt(byteBuffer.getInt(A00) + A00);
        int i4 = A00 + byteBuffer.getInt(A00) + 4;
        C303796Au[] r3 = (C303796Au[]) Array.newInstance(cls, i3);
        for (int i5 = 0; i5 < i3; i5++) {
            int i6 = (i5 * 4) + i4;
