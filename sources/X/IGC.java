...
public final class IGC implements C288835cZ {
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof IGC) {
                IGC igc = (IGC) obj;
                if (!0qQ.A0K(this.A01, igc.A01) || this.A00 != igc.A00 || !0qQ.A0K(this.A02, igc.A02) || !0qQ.A0K(this.A03, igc.A03)) {
                    return false;
                }
            }
            return false;
    ...
    public IGC(I4L i4l, C56072HsL hsL, C62320sa r3, int i) {
        this.A01 = i4l;
        this.A00 = i;
        this.A02 = hsL;
        this.A03 = r3;
    ...
    public final C289145d6 Cny(C268074ci r7, C268004cb r8, long j) {
        ...
        if (CmY >= A012) {
            j = Constraints.A04(Constraints.A03(j), Integer.MAX_VALUE, Constraints.A02(j), A002);
        }
        C267974cY Cnz = r7.Cnz(j);
        int min = Math.min(Cnz.A01, A012);
        return C51969G9p.A0a(r8, new C59093J6a(min, 0, (Object) Cnz, (Object) r8, (Object) this), min, Cnz.A00);
    }
    ...
    public final String toString() {
        ...
        A1A.append("HorizontalScrollLayoutModifier(scrollerPosition=");
        A1A.append(this.A01);
