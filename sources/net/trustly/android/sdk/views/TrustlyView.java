...
public class TrustlyView extends LinearLayout {
    ...
    public TrustlyView(Context context, AttributeSet attributeSet, int i, String str) {
        ...
        webView.addJavascriptInterface(new S43(this), "TrustlyNativeSDK");
        webView.setWebChromeClient(new C7368Q8r(this, this));
        webView.setWebViewClient(new Q94(2, this, this));
        addView(webView);
    }

    public TrustlyView(Context context, String str) {
        this(context, (AttributeSet) null, 0, (String) null);
    }
